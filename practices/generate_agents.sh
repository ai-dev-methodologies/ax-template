...
# Inline disk-truth assertions (IMW6 FMW: 22 L4 = 21 prior + data-subject-rights full_trio / 11 recipes / 13 verdicts)
...
[[ "$L4_COUNT"  == "22" ]] || { echo "ASSERT FAIL: L4 $L4_COUNT != 22"  >&2; exit 1; }
