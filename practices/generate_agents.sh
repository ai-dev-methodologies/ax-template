...
# Inline disk-truth assertions (R93: 21 L4 = 20 prior + multi-tenant backend-only stub / 11 recipes / 13 verdicts)
...
[[ "$L4_COUNT"  == "21" ]] || { echo "ASSERT FAIL: L4 $L4_COUNT != 21"  >&2; exit 1; }
