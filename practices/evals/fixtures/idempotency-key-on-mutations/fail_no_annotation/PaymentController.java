 ...
 * Demonstrates WRONG pattern: POST mutation handler missing @RequireIdempotencyKey.
 * Guard must catch: POST endpoint in payment/notification/email-outbox domain
 * without @RequireIdempotencyKey annotation — network retries will double-charge.
...
public class PaymentController {
    ...
    // VIOLATION: POST mutation that creates a payment has no @RequireIdempotencyKey.
