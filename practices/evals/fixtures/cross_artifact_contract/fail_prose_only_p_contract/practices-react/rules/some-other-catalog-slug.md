...
INDEX.md) is sufficient coverage on its own. This fixture's actual failure is entirely
check (a) (see skills/ax-install-hooks/SKILL.md); check (b) must stay clean here.
