# hibernate-validator — upstream snapshot (2026-08-01 refresh, append-only)

**Source URL(s):** https://docs.jboss.org/hibernate/validator/8.0/reference/en-US/html_single/ (re-fetched 2026-08-01; every pre-existing section below the divider is preserved verbatim)
**HTTP status:** 200
**Fetched at:** 2026-08-01T02:23:46Z
**Extractor invocation:** `practices/scripts/snapshot-extract.sh https://docs.jboss.org/hibernate/validator/8.0/reference/en-US/html_single/`
**Fetch receipt:** `practices/upstream/_FETCH-RECEIPTS.yaml` id `r116`
**Body SHA-256 (below the `---` divider, header excluded):** 419378e38277fadf7a2ef505e266ddfe3394eee2b29e6dfc68ba0aff1c555526
...
Source: https://docs.jboss.org/hibernate/validator/8.0/reference/en-US/html_single/
HTTP status: 200 · extracted bytes: 315270 · sha256: 3507a6ebde9cf6f19d6b30b54c02d21a6548b1a95030a6880c8d7cc1599921c5
