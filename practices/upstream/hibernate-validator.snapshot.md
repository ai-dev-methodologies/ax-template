...
<title>Hibernate Validator 8.0.5.Final - Jakarta Bean Validation Reference Implementation: Reference Guide</title>
...
<div id="header">
<h1>Hibernate Validator 8.0.5.Final - Jakarta Bean Validation Reference Implementation: Reference Guide</h1>
<div class="details">
...
<span id="revdate">2026-07-26</span>
</div>
...
<ul class="sectlevel2">
<li><a href="#validator-gettingstarted-createproject">1.1. Project set up</a>
<ul class="sectlevel3">
<li><a href="#validator-gettingstarted-uel">1.1.1. Unified EL</a></li>
<li><a href="#section-getting-started-cdi">1.1.2. CDI</a></li>
<li><a href="#section-getting-started-security-manager">1.1.3. Running with a security manager</a></li>
<li><a href="#_updating_hibernate_validator_in_wildfly">1.1.4. Updating Hibernate Validator in WildFly</a></li>
<li><a href="#validator-gettingstarted-modulepath">1.1.5.  Running in the modulepath</a></li>
</ul>
</li>
...
<li><a href="#validator-gettingstarted-whatsnext">1.4. Where to go next?</a></li>
</ul>
</li>
<li><a href="#chapter-bean-constraints">2. Declaring and validating bean constraints</a>
<ul class="sectlevel2">
<li><a href="#section-declaring-bean-constraints">2.1. Declaring bean constraints</a>
<ul class="sectlevel3">
<li><a href="#_field_level_constraints">2.1.1. Field-level constraints</a></li>
<li><a href="#_property_level_constraints">2.1.2. Property-level constraints</a></li>
<li><a href="#container-element-constraints">2.1.3. Container element constraints</a>
<ul class="sectlevel4">
<li><a href="#_with_iterable">2.1.3.1. With <code>Iterable</code></a></li>
<li><a href="#_with_list">2.1.3.2. With <code>List</code></a></li>
<li><a href="#_with_map">2.1.3.3. With <code>Map</code></a></li>
<li><a href="#_with_java_util_optional">2.1.3.4. With <code>java.util.Optional</code></a></li>
<li><a href="#_with_custom_container_types">2.1.3.5. With custom container types</a></li>
<li><a href="#_nested_container_elements">2.1.3.6. Nested container elements</a></li>
</ul>
</li>
<li><a href="#validator-usingvalidator-classlevel">2.1.4. Class-level constraints</a></li>
<li><a href="#section-constraint-inheritance">2.1.5. Constraint inheritance</a></li>
<li><a href="#section-object-graph-validation">2.1.6. Object graphs</a></li>
</ul>
</li>
<li><a href="#section-validating-bean-constraints">2.2. Validating bean constraints</a>
<ul class="sectlevel3">
<li><a href="#section-obtaining-validator">2.2.1. Obtaining a <code>Validator</code> instance</a></li>
<li><a href="#_validator_methods">2.2.2. Validator methods</a>
<ul class="sectlevel4">
<li><a href="#_validatorvalidate">2.2.2.1. <code>Validator#validate()</code></a></li>
<li><a href="#_validatorvalidateproperty">2.2.2.2. <code>Validator#validateProperty()</code></a></li>
<li><a href="#_validatorvalidatevalue">2.2.2.3. <code>Validator#validateValue()</code></a></li>
</ul>
</li>
<li><a href="#section-constraint-violation-methods">2.2.3. <code>ConstraintViolation</code></a>
<ul class="sectlevel4">
<li><a href="#_constraintviolation_methods">2.2.3.1. <code>ConstraintViolation</code> methods</a></li>
<li><a href="#_exploiting_the_property_path">2.2.3.2. Exploiting the property path</a></li>
</ul>
</li>
</ul>
</li>
<li><a href="#section-builtin-constraints">2.3. Built-in constraints</a>
<ul class="sectlevel3">
<li><a href="#validator-defineconstraints-spec">2.3.1. Jakarta Bean Validation constraints</a></li>
<li><a href="#validator-defineconstraints-hv-constraints">2.3.2. Additional constraints</a>
<ul class="sectlevel4">
<li><a href="#_country_specific_constraints">2.3.2.1. Country specific constraints</a></li>
</ul>
</li>
</ul>
</li>
...
<ul class="sectlevel2">
<li><a href="#section-declaring-method-constraints">3.1. Declaring method constraints</a>
<ul class="sectlevel3">
<li><a href="#_parameter_constraints">3.1.1. Parameter constraints</a>
<ul class="sectlevel4">
<li><a href="#_cross_parameter_constraints">3.1.1.1. Cross-parameter constraints</a></li>
</ul>
</li>
<li><a href="#_return_value_constraints">3.1.2. Return value constraints</a></li>
<li><a href="#_cascaded_validation">3.1.3. Cascaded validation</a></li>
<li><a href="#section-method-constraints-inheritance-hierarchies">3.1.4. Method constraints in inheritance hierarchies</a></li>
</ul>
</li>
<li><a href="#section-validating-executable-constraints">3.2. Validating method constraints</a>
<ul class="sectlevel3">
<li><a href="#section-obtaining-executable-validator">3.2.1. Obtaining an <code>ExecutableValidator</code> instance</a></li>
<li><a href="#section-executable-validator-methods">3.2.2. <code>ExecutableValidator</code> methods</a>
<ul class="sectlevel4">
<li><a href="#_executablevalidatorvalidateparameters">3.2.2.1. <code>ExecutableValidator#validateParameters()</code></a></li>
<li><a href="#_executablevalidatorvalidatereturnvalue">3.2.2.2. <code>ExecutableValidator#validateReturnValue()</code></a></li>
<li><a href="#_executablevalidatorvalidateconstructorparameters">3.2.2.3. <code>ExecutableValidator#validateConstructorParameters()</code></a></li>
<li><a href="#_executablevalidatorvalidateconstructorreturnvalue">3.2.2.4. <code>ExecutableValidator#validateConstructorReturnValue()</code></a></li>
</ul>
</li>
<li><a href="#_constraintviolation_methods_for_method_validation">3.2.3. <code>ConstraintViolation</code> methods for method validation</a></li>
</ul>
</li>
...
<ul class="sectlevel2">
<li><a href="#section-message-interpolation">4.1. Default message interpolation</a>
<ul class="sectlevel3">
<li><a href="#section-special-characters">4.1.1. Special characters</a></li>
<li><a href="#section-interpolation-with-message-expressions">4.1.2. Interpolation with message expressions</a></li>
<li><a href="#_examples">4.1.3. Examples</a></li>
</ul>
</li>
<li><a href="#section-custom-message-interpolation">4.2. Custom message interpolation</a>
<ul class="sectlevel3">
...
<li><a href="#section-default-group-class">5.4. Redefining the default group sequence</a>
<ul class="sectlevel3">
...
<ul class="sectlevel2">
<li><a href="#validator-customconstraints-simple">6.1. Creating a simple constraint</a>
<ul class="sectlevel3">
<li><a href="#validator-customconstraints-constraintannotation">6.1.1. The constraint annotation</a></li>
<li><a href="#section-constraint-validator">6.1.2. The constraint validator</a>
<ul class="sectlevel4">
<li><a href="#_the_constraintvalidatorcontext">6.1.2.1. The <code>ConstraintValidatorContext</code></a></li>
<li><a href="#constraint-validator-hibernateconstraintvalidator">6.1.2.2. The <code>HibernateConstraintValidator</code> extension</a></li>
<li><a href="#constraint-validator-payload">6.1.2.3. Passing a payload to the constraint validator</a></li>
</ul>
</li>
...
<li><a href="#section-script-evaluator-factory">9.2.9. Configuring the <code>ScriptEvaluatorFactory</code></a>
<ul class="sectlevel4">
<li><a href="#_xml_configuration">9.2.9.1. XML configuration</a></li>
<li><a href="#_programmatic_configuration">9.2.9.2. Programmatic configuration</a></li>
<li><a href="#_custom_scriptevaluatorfactory_implementation_examples">9.2.9.3. Custom <code>ScriptEvaluatorFactory</code> implementation examples</a></li>
</ul>
</li>
<li><a href="#_logging_of_values_under_validation">9.2.10. Logging of values under validation</a></li>
</ul>
</li>
...
<li><a href="#_method_validation">11.3.2. Method validation</a>
<ul class="sectlevel4">
<li><a href="#_validated_executable_types">11.3.2.1. Validated executable types</a></li>
</ul>
</li>
</ul>
</li>
<li><a href="#_jakarta_ee">11.4. Jakarta EE</a></li>
...
<ul class="sectlevel3">
<li><a href="#validator-annotationprocessor-commandline">13.4.1. Command line builds</a>
<ul class="sectlevel4">
<li><a href="#validator-annotationprocessor-maven">13.4.1.1. Maven</a></li>
<li><a href="#validator-annotationprocessor-gradle">13.4.1.2. Gradle</a></li>
<li><a href="#validator-annotationprocessor-ant">13.4.1.3. Apache Ant</a></li>
<li><a href="#validator-annotationprocessor-javac">13.4.1.4. javac</a></li>
</ul>
</li>
<li><a href="#validator-annotationprocessor-ide">13.4.2. IDE builds</a>
<ul class="sectlevel4">
<li><a href="#_eclipse">13.4.2.1. Eclipse</a></li>
<li><a href="#validator-annotationprocessor-idea">13.4.2.2. IntelliJ IDEA</a></li>
<li><a href="#validator-annotationprocessor-netbeans">13.4.2.3. NetBeans</a></li>
</ul>
</li>
</ul>
</li>
...
<div class="paragraph">
<p>Jakarta Bean Validation 3.0 defines a metadata model and API for entity and method validation.
...
<div class="paragraph">
<p>Hibernate Validator 8 and Jakarta Bean Validation 3.0 require Java 11 or later.</p>
</div>
</div>
</div>
<div class="sect1">
...
(<code>jakarta.validation:jakarta.validation-api:3.0.2</code>).</p>
</div>
<div class="sect3">
...
violation messages (see <a href="#section-message-interpolation">Section 4.1, &#8220;Default message interpolation&#8221;</a>). When your application runs in a Jakarta EE
...
<a href="#non-el-message-interpolator">Section 12.10, &#8220;<code>ParameterMessageInterpolator</code>&#8221;</a>. However, the use of this interpolator
...
<div class="paragraph">
<p>Note that adding this dependency is usually not required for applications running on a Jakarta EE
application server. You can learn more about the integration of Jakarta Bean Validation and CDI in
<a href="#section-integration-with-cdi">Section 11.3, &#8220;CDI&#8221;</a>.</p>
</div>
</div>
<div class="sect3">
...
<div class="paragraph">
<p>Hibernate Validator supports running with a <a href="https://docs.oracle.com/javase/8/docs/technotes/guides/security/index.html">security manager</a> being enabled.
...
The following shows how to do this via a <a href="https://docs.oracle.com/javase/8/docs/technotes/guides/security/PolicyFiles.html">policy file</a> as processed by the Java default policy implementation:</p>
</div>
<div class="exampleblock">
...
<div class="listingblock">
<div class="content">
<pre class="prettyprint highlight"><code data-lang="XML">grant codeBase "file:path/to/hibernate-validator-8.0.5.Final.jar" {
...
grant codeBase "file:path/to/jakarta.validation-api-3.0.2.jar" {
    permission java.io.FilePermission "path/to/hibernate-validator-8.0.5.Final.jar", "read";
};
...
<div class="exampleblock">
<div class="title">Example 1.5: Maven dependency for WildFly 27.0.1.Final patch file</div>
<div class="content">
<div class="listingblock">
<div class="content">
<pre class="prettyprint highlight"><code data-lang="XML">&lt;dependency&gt;
    ...
    &lt;version&gt;8.0.5.Final&lt;/version&gt;
    &lt;classifier&gt;wildfly-27.0.1.Final-patch&lt;/classifier&gt;
    &lt;type&gt;zip&lt;/type&gt;
&lt;/dependency&gt;</code></pre>
</div>
</div>
...
<div class="paragraph">
<p>We also provide a patch for WildFly :</p>
</div>
<div class="exampleblock">
<div class="title">Example 1.6: Maven dependency for WildFly  patch file</div>
<div class="content">
<div class="listingblock">
<div class="content">
<pre class="prettyprint highlight"><code data-lang="XML">&lt;dependency&gt;
...
<div class="listingblock">
<div class="content">
<pre class="prettyprint highlight"><code>$JBOSS_HOME/bin/jboss-cli.sh patch apply hibernate-validator-modules-8.0.5.Final-wildfly-27.0.1.Final-patch.zip</code></pre>
</div>
</div>
</div>
</div>
...
<div class="sect3">
<h4 id="validator-gettingstarted-modulepath"><a class="anchor" href="#validator-gettingstarted-modulepath"></a>1.1.5. <a id="validator-gettingstarted-java9"></a> Running in the modulepath</h4>
<div class="paragraph">
<p>Support for the Java Platform Module System (JPMS) is present in a preliminary form.
There are no JPMS module descriptors provided, but Hibernate Validator is usable as automatic modules.</p>
</div>
<div class="paragraph">
...
<ul>
<li>
<p>Jakarta Bean Validation API: <code>jakarta.validation</code></p>
</li>
<li>
...
Validator
<a href="https://github.com/hibernate/hibernate-validator/tree/main/documentation/src/test">source repository</a>
on GitHub.</p>
</div>
</td>
</tr>
...
<div class="sect2">
<h3 id="validator-gettingstarted-whatsnext"><a class="anchor" href="#validator-gettingstarted-whatsnext"></a>1.4. Where to go next?</h3>
<div class="paragraph">
...
<a href="#validator-further-reading">Chapter 14, <em>Further reading</em></a>.</p>
</div>
<div class="paragraph">
<p>To learn more about the validation of beans and properties, just continue reading
<a href="#chapter-bean-constraints">Chapter 2, <em>Declaring and validating bean constraints</em></a>. If you are interested in using Jakarta Bean Validation for the validation of
method pre- and postcondition refer to <a href="#chapter-method-constraints">Chapter 3, <em>Declaring and validating method constraints</em></a>. In case your application has
specific validation requirements have a look at <a href="#validator-customconstraints">Chapter 6, <em>Creating custom constraints</em></a>.</p>
</div>
</div>
</div>
</div>
...
<div class="sectionbody">
<div class="paragraph">
<p>In this chapter you will learn how to declare (see <a href="#section-declaring-bean-constraints">Section 2.1, &#8220;Declaring bean constraints&#8221;</a>) and
validate (see <a href="#section-validating-bean-constraints">Section 2.2, &#8220;Validating bean constraints&#8221;</a>) bean constraints.
<a href="#section-builtin-constraints">Section 2.3, &#8220;Built-in constraints&#8221;</a> provides an overview of all built-in constraints coming with
Hibernate Validator.</p>
</div>
<div class="paragraph">
<p>If you are interested in applying constraints to method parameters and return values, refer to
<a href="#chapter-method-constraints">Chapter 3, <em>Declaring and validating method constraints</em></a>.</p>
</div>
<div class="sect2">
...
<a href="#validator-customconstraints">Chapter 6, <em>Creating custom constraints</em></a> for more information.</p>
</div>
</td>
</tr>
</table>
...
<div class="paragraph">
<p>Constraints can be expressed by annotating a field of a class. <a href="#example-field-level">Example 2.1, &#8220;Field-level constraints&#8221;</a> shows a field
...
<div class="listingblock">
<div class="content">
<pre class="prettyprint highlight"><code data-lang="JAVA">package org.hibernate.validator.referenceguide.chapter02.fieldlevel;
...
<a href="#example-property-level">Example 2.2, &#8220;Property-level constraints&#8221;</a> uses the same entity as in <a href="#example-field-level">Example 2.1, &#8220;Field-level constraints&#8221;</a>, however, property level
...
<div class="listingblock">
<div class="content">
<pre class="prettyprint highlight"><code data-lang="JAVA">package org.hibernate.validator.referenceguide.chapter02.propertylevel;
...
<div class="sect3">
<h4 id="container-element-constraints"><a class="anchor" href="#container-element-constraints"></a>2.1.3. Container element constraints</h4>
<div class="paragraph">
...
<div class="paragraph">
<p>It also supports container element constraints on custom container types (see <a href="#chapter-valueextraction">Chapter 7, <em>Value extraction</em></a>).</p>
</div>
<div class="admonitionblock note">
<table>
<tr>
...
<div class="sect4">
<h5 id="_with_iterable"><a class="anchor" href="#_with_iterable"></a>2.1.3.1. With <code>Iterable</code></h5>
<div class="paragraph">
<p>When applying constraints on an <code>Iterable</code> type argument, Hibernate Validator will validate each
element. <a href="#example-container-element-constraints-iterable">Example 2.3, &#8220;Container element constraint on <code>Set</code>&#8221;</a> shows an example of a
...
<div class="listingblock">
<div class="content">
<pre class="prettyprint highlight"><code data-lang="JAVA">package org.hibernate.validator.referenceguide.chapter02.containerelement.set;
...
<div class="listingblock">
<div class="content">
<pre class="prettyprint highlight"><code data-lang="JAVA">Car car = new Car();
car.addPart( "Wheel" );
car.addPart( null );
...
<div class="sect4">
<h5 id="_with_list"><a class="anchor" href="#_with_list"></a>2.1.3.2. With <code>List</code></h5>
<div class="paragraph">
<p>When applying constraints on a <code>List</code> type argument, Hibernate Validator will validate each
element. <a href="#example-container-element-constraints-list">Example 2.4, &#8220;Container element constraint on <code>List</code>&#8221;</a> shows an example of a
...
<div class="listingblock">
<div class="content">
<pre class="prettyprint highlight"><code data-lang="JAVA">package org.hibernate.validator.referenceguide.chapter02.containerelement.list;
...
<div class="sect4">
<h5 id="_with_map"><a class="anchor" href="#_with_map"></a>2.1.3.3. With <code>Map</code></h5>
<div class="paragraph">
<p>Container element constraints are also validated on map keys and values.
<a href="#example-container-element-constraints-map">Example 2.5, &#8220;Container element constraint on map keys and values&#8221;</a> shows an example of a <code>Map</code> with a constraint on the key
...
<div class="listingblock">
<div class="content">
<pre class="prettyprint highlight"><code data-lang="JAVA">package org.hibernate.validator.referenceguide.chapter02.containerelement.map;
...
<div class="sect4">
<h5 id="_with_java_util_optional"><a class="anchor" href="#_with_java_util_optional"></a>2.1.3.4. With <code>java.util.Optional</code></h5>
<div class="paragraph">
<p>When applying a constraint on the type argument of <code>Optional</code>, Hibernate Validator will automatically
unwrap the type and validate the internal value. <a href="#example-container-element-constraints-optional">Example 2.6, &#8220;Container element constraint on Optional&#8221;</a> shows
...
<div class="listingblock">
<div class="content">
<pre class="prettyprint highlight"><code data-lang="JAVA">package org.hibernate.validator.referenceguide.chapter02.containerelement.optional;
...
<div class="sect4">
<h5 id="_with_custom_container_types"><a class="anchor" href="#_with_custom_container_types"></a>2.1.3.5. With custom container types</h5>
<div class="paragraph">
...
the value(s) to validate (see <a href="#chapter-valueextraction">Chapter 7, <em>Value extraction</em></a> for more information about how to implement
your own <code>ValueExtractor</code> and how to register it).</p>
</div>
<div class="paragraph">
<p><a href="#example-container-element-constraints-custom-container-type">Example 2.7, &#8220;Container element constraint on custom container type&#8221;</a> shows an example of a custom
...
<div class="listingblock">
<div class="content">
<pre class="prettyprint highlight"><code data-lang="JAVA">package org.hibernate.validator.referenceguide.chapter02.containerelement.custom;
...
<div class="sect4">
<h5 id="_nested_container_elements"><a class="anchor" href="#_nested_container_elements"></a>2.1.3.6. Nested container elements</h5>
<div class="paragraph">
<p>Constraints are also supported on nested container elements.</p>
</div>
<div class="paragraph">
<p>When validating a <code>Car</code> object as presented in <a href="#example-container-element-nested">Example 2.8, &#8220;Constraints on nested container elements&#8221;</a>, both the <code>@NotNull</code>
...
<div class="listingblock">
<div class="content">
<pre class="prettyprint highlight"><code data-lang="JAVA">package org.hibernate.validator.referenceguide.chapter02.containerelement.nested;
...
<div class="paragraph">
<p>The <code>Car</code> class in <a href="#example-class-level">Example 2.9, &#8220;Class-level constraint&#8221;</a> has the two attributes <code>seatCount</code> and <code>passengers</code> and it
...
<div class="paragraph">
<p>Refer to <a href="#section-class-level-constraints">Section 6.2, &#8220;Class-level constraints&#8221;</a> to learn in detail how to implement this custom
constraint.</p>
</div>
...
<div class="listingblock">
<div class="content">
<pre class="prettyprint highlight"><code data-lang="JAVA">package org.hibernate.validator.referenceguide.chapter02.classlevel;
...
<div class="listingblock">
<div class="content">
<pre class="prettyprint highlight"><code data-lang="JAVA">package org.hibernate.validator.referenceguide.chapter02.inheritance;
...
reference to another object with <code>@Valid</code> as demonstrated in <a href="#example-cascaded-validation">Example 2.11, &#8220;Cascaded validation&#8221;</a>.</p>
</div>
...
<div class="listingblock">
<div class="content">
<pre class="prettyprint highlight"><code data-lang="JAVA">package org.hibernate.validator.referenceguide.chapter02.objectgraph;
...
<div class="listingblock">
<div class="content">
<pre class="prettyprint highlight"><code data-lang="JAVA">package org.hibernate.validator.referenceguide.chapter02.objectgraph.containerelement;
...
<div class="paragraph">
<p>When validating an instance of the <code>Car</code> class shown in <a href="#example-cascaded-validation-list">Example 2.12, &#8220;Cascaded validation of containers&#8221;</a>, a
...
<div class="paragraph">
<p>This bootstraps a validator in the default configuration. Refer to <a href="#chapter-bootstrapping">Chapter 9, <em>Bootstrapping</em></a> to
...
is discussed in detail in <a href="#chapter-groups">Chapter 5, <em>Grouping constraints</em></a>.</p>
</div>
<div class="sect4">
...
<a href="#example-validator-validate">Example 2.14, &#8220;Using <code>Validator#validate()</code>&#8221;</a> shows the validation of an instance of the <code>Car</code> class from
<a href="#example-property-level">Example 2.2, &#8220;Property-level constraints&#8221;</a> which fails to satisfy the <code>@NotNull</code> constraint on the <code>manufacturer</code>
...
<div class="listingblock">
<div class="content">
<pre class="prettyprint highlight"><code data-lang="JAVA">Car car = new Car( null, true );
...
<div class="listingblock">
<div class="content">
<pre class="prettyprint highlight"><code data-lang="JAVA">Set&lt;ConstraintViolation&lt;Car&gt;&gt; constraintViolations = validator.validateValue(
        Car.class,
        "manufacturer",
        null
);
...
(see <a href="#section-presentation-layer">Section 11.2, &#8220;JSF &amp; Seam&#8221;</a>) to perform a validation of the values entered into a form
...
<div class="sect4">
<h5 id="_constraintviolation_methods"><a class="anchor" href="#_constraintviolation_methods"></a>2.2.3.1. <code>ConstraintViolation</code> methods</h5>
<div class="paragraph">
...
The values under "Example" column refer to <a href="#example-validator-validate">Example 2.14, &#8220;Using <code>Validator#validate()</code>&#8221;</a>.</p>
</div>
<div class="dlist">
<dl>
...
<div class="sect4">
<h5 id="_exploiting_the_property_path"><a class="anchor" href="#_exploiting_the_property_path"></a>2.2.3.2. Exploiting the property path</h5>
<div class="paragraph">
...
<a href="https://jakarta.ee/specifications/bean-validation/3.0/jakarta-bean-validation-spec-3.0.html#validationapi-constraintviolation">the <code>ConstraintViolation</code> section</a> of the
...
constraints defined by the Jakarta Bean Validation specification (see <a href="#validator-defineconstraints-spec">Section 2.3.1, &#8220;Jakarta Bean Validation constraints&#8221;</a>).
Additionally, Hibernate Validator provides useful custom constraints (see
<a href="#validator-defineconstraints-hv-constraints">Section 2.3.2, &#8220;Additional constraints&#8221;</a>).</p>
</div>
<div class="sect3">
<h4 id="validator-defineconstraints-spec"><a class="anchor" href="#validator-defineconstraints-spec"></a>2.3.1. Jakarta Bean Validation constraints</h4>
<div class="paragraph">
...
<dd>
<p>Checks that the annotated character sequence is a valid <a href="https://en.wikipedia.org/wiki/International_Article_Number_%28EAN%29">EAN</a> barcode. type determines the type of barcode. The default is EAN-13.</p>
<div class="dlist">
<dl>
<dt class="hdlist1">Supported data types</dt>
<dd>
...
<dd>
<p>Checks that the digits within the annotated character sequence pass the Luhn checksum algorithm (see also <a href="https://en.wikipedia.org/wiki/Luhn_algorithm">Luhn algorithm</a>). <code>startIndex</code> and <code>endIndex</code> allow to only run the algorithm on the specified sub-string. <code>checkDigitIndex</code> allows to use an arbitrary digit within the character sequence as the check digit. If not specified it is assumed that the check digit is part of the specified range. Last but not least, <code>ignoreNonDigitCharacters</code> allows to ignore non digit characters.</p>
<div class="dlist">
<dl>
<dt class="hdlist1">Supported data types</dt>
<dd>
...
<dt class="hdlist1"><code>@UUID(allowEmpty=, allowNil=, version=, variant=, letterCase=)</code></dt>
<dd>
<p>Checks that the annotated character sequence is a valid universally unique identifier according to RFC 4122. <code>null</code> is always valid. The option <code>allowEmpty</code> allows empty character sequences. <code>allowNil</code> includes nil UUIDs (<code>00000000-0000-0000-0000-000000000000</code>). The <code>version</code> and <code>variant</code> parameters control which UUID versions and variants are allowed. <code>letterCase</code> ensures lower case or upper case, but can also be configured as case insensitive.</p>
<div class="dlist">
<dl>
<dt class="hdlist1">Supported data types</dt>
<dd>
...
<div class="sect4">
<h5 id="_country_specific_constraints"><a class="anchor" href="#_country_specific_constraints"></a>2.3.2.1. Country specific constraints</h5>
<div class="paragraph">
...
<dd>
<p>Checks that the annotated character sequence represents a Brazilian corporate tax payer registry number (Cadastro de Pessoa Jurídica). An optional <code>format</code> parameter allows picking which format of CNPJ should be considered valid <code>NUMERIC</code>, the current format, or <code>ALPHANUMERIC</code>, the one that will replace the current one starting January 2026.</p>
<div class="dlist">
<dl>
<dt class="hdlist1">Supported data types</dt>
<dd>
...
constraint. You can find more information in <a href="#validator-customconstraints">Chapter 6, <em>Creating custom constraints</em></a>.</p>
</div>
</td>
</tr>
</table>
...
parameters as demonstrated in <a href="#example-declaring-parameter-constraints">Example 3.1, &#8220;Declaring method and constructor parameter constraints&#8221;</a>.</p>
</div>
...
<ul>
<li>
<p>The <code>name</code> passed to the <code>RentalStation</code> constructor must not be <code>null</code></p>
</li>
<li>
...
<a href="#section-validating-executable-constraints">Section 3.2, &#8220;Validating method constraints&#8221;</a>) must be used to perform the validation, which is
...
<div class="sect4">
<h5 id="_cross_parameter_constraints"><a class="anchor" href="#_cross_parameter_constraints"></a>3.1.1.1. Cross-parameter constraints</h5>
<div class="paragraph">
...
or constructor as you can see in <a href="#example-using-cross-parameter-constraint">Example 3.2, &#8220;Declaring a cross-parameter constraint&#8221;</a>. Here the cross-
...
<a href="#section-cross-parameter-constraints">Section 6.3, &#8220;Cross-parameter constraints&#8221;</a> which shows how to implement your own cross-parameter constraint.</p>
</div>
<div class="paragraph">
...
specify the constraint target. As shown in <a href="#example-specifying-constraint-target">Example 3.3, &#8220;Specifying a constraint&#8217;s target&#8221;</a> you apply the
...
executable as shown in <a href="#example-declaring-return-value-constraints">Example 3.4, &#8220;Declaring method and constructor return value constraints&#8221;</a>.</p>
</div>
...
<a href="#section-object-graph-validation">Section 2.1.6, &#8220;Object graphs&#8221;</a>), the <code>@Valid</code> annotation can be used to mark executable
...
<div class="paragraph">
<p>In <a href="#example-cascaded-executable-validation">Example 3.5, &#8220;Marking executable parameters and return values for cascaded validation&#8221;</a>, the <code>car</code> parameter of the method <code>Garage#checkCar()</code> as
...
<a href="#example-cascaded-executable-validation-container-elements">Example 3.6, &#8220;Container elements of method parameter marked for cascaded validation&#8221;</a>, each element instance of the passed list
...
also known as the <a href="https://en.wikipedia.org/wiki/Liskov_substitution_principle">Liskov
...
<a href="#example-illegal-parameter-constraints">Example 3.7, &#8220;Illegal method parameter constraint in subtype&#8221;</a> shows a violation of this rule.</p>
</div>
...
types in <a href="#example-illegal-parameter-constraints-parallel-types">Example 3.8, &#8220;Illegal method parameter constraint in parallel types of a hierarchy&#8221;</a> demonstrate a violation of that
...
<a href="#example-return-value-constraints-in-hierarchy">Example 3.9, &#8220;Return value constraints on supertype and subtype method&#8221;</a>, the <code>@Size</code> constraint on the method itself as well
...
the <code>Validator</code> instance. See also <a href="#section-method-validation-prerequisite-relaxation">Section 12.3, &#8220;Relaxation of requirements for method validation in class hierarchies&#8221;</a>.</p>
</div>
</td>
</tr>
</table>
...
<div class="paragraph">
<p>In <a href="#section-obtaining-executable-validator">Section 3.2.1, &#8220;Obtaining an <code>ExecutableValidator</code> instance&#8221;</a> you will learn how to obtain an <code>ExecutableValidator</code>
instance while <a href="#section-executable-validator-methods">Section 3.2.2, &#8220;<code>ExecutableValidator</code> methods&#8221;</a> shows how to use the different methods
...
<a href="#example-obtaining-executable-validator">Example 3.10, &#8220;Obtaining an <code>ExecutableValidator</code> instance&#8221;</a>.</p>
</div>
...
<a href="#chapter-bootstrapping">Chapter 9, <em>Bootstrapping</em></a>, for instance in order to use a specific parameter name provider
(see <a href="#section-parameter-name-provider">Section 9.2.4, &#8220;<code>ParameterNameProvider</code>&#8221;</a>).</p>
</div>
</div>
<div class="sect3">
...
shown in <a href="#example-executable-validator-class-car">Example 3.11, &#8220;Class <code>Car</code> with constrained methods and constructors&#8221;</a>.</p>
</div>
...
<a href="#example-executable-validator-validate-parameters">Example 3.12, &#8220;Using <code>ExecutableValidator#validateParameters()</code>&#8221;</a> shows an example. The validation results in a
...
<a href="#example-executable-validator-validate-return-value">Example 3.13, &#8220;Using <code>ExecutableValidator#validateReturnValue()</code>&#8221;</a> yields one constraint violation since the
...
shown in method <a href="#example-executable-validator-validate-constructor-parameters">Example 3.14, &#8220;Using <code>ExecutableValidator#validateConstructorParameters()</code>&#8221;</a>. Due to the
...
<a href="#example-executable-validator-validate-constructor-return-value">Example 3.15, &#8220;Using <code>ExecutableValidator#validateConstructorReturnValue()</code>&#8221;</a>, <code>validateConstructorReturnValue()</code>
...
<div class="sect3">
<h4 id="_constraintviolation_methods_for_method_validation"><a class="anchor" href="#_constraintviolation_methods_for_method_validation"></a>3.2.3. <code>ConstraintViolation</code> methods for method validation</h4>
<div class="paragraph">
<p>In addition to the methods introduced in <a href="#section-constraint-violation-methods">Section 2.2.3, &#8220;<code>ConstraintViolation</code>&#8221;</a>,
...
<a href="https://jakarta.ee/specifications/bean-validation/3.0/apidocs//?jakarta/validation/metadata/BeanDescriptor.html">JavaDoc</a>
...
path nodes. How this can be done is shown in <a href="#example-executable-validation-property-path">Example 3.16, &#8220;Retrieving method and parameter information&#8221;</a>.</p>
</div>
...
<a href="#section-builtin-constraints">Section 2.3, &#8220;Built-in constraints&#8221;</a>, Hibernate Validator currently provides one method-level constraint,
...
the active parameter name provider (see <a href="#section-parameter-name-provider">Section 9.2.4, &#8220;<code>ParameterNameProvider</code>&#8221;</a>).
<a href="#example-parameterscriptassert">Example 3.17, &#8220;Using <code>@ParameterScriptAssert</code>&#8221;</a> shows how the validation logic of the <code>@LuggageCountMatchesPassengerCount</code>
constraint from <a href="#example-using-cross-parameter-constraint">Example 3.2, &#8220;Declaring a cross-parameter constraint&#8221;</a> could be expressed with the help of
...
descriptor can be overridden with a specific value as shown in <a href="#example-overriding-message">Example 4.1, &#8220;Specifying a message descriptor using the message attribute&#8221;</a>.</p>
</div>
...
Language. See <a href="#section-interpolation-with-message-expressions">Section 4.1.2, &#8220;Interpolation with message expressions&#8221;</a> to learn more about the usage of
...
<a href="https://jakarta.ee/specifications/bean-validation/3.0/jakarta-bean-validation-spec-3.0.html#validationapi-message-defaultmessageinterpolation-resolutionalgorithm">6.3.1.1</a>
...
<div class="paragraph">
<p><a href="#example-message-descriptors">Example 4.2, &#8220;Specifying message descriptors&#8221;</a> shows how to make use of the different options for specifying
...
assertions in <a href="#example-expected-error-messages">Example 4.3, &#8220;Expected error messages&#8221;</a>:</p>
</div>
<div class="ulist">
<ul>
<li>
...
interpolation context (see <a href="#section-hibernateconstraintvalidatorcontext">Section 12.13.1, &#8220;<code>HibernateConstraintValidatorContext</code>&#8221;</a>), an EL expression in the
...
<a href="#section-configuration-validation-xml">Section 8.1, &#8220;Configuring the validator factory in <em>validation.xml</em>&#8221;</a>) or by passing it when bootstrapping a <code>ValidatorFactory</code> or
<code>Validator</code> (see <a href="#section-validator-factory-message-interpolator">Section 9.2.1, &#8220;<code>MessageInterpolator</code>&#8221;</a> and
<a href="#section-configuring-validator">Section 9.3, &#8220;Configuring a Validator&#8221;</a>, respectively).</p>
</div>
<div class="sect3">
...
<code>ValidatorFactory</code> as shown in <a href="#example-using-specific-resource-bundle-locator">Example 4.4, &#8220;Using a specific resource bundle&#8221;</a>.</p>
</div>
...
<a href="#example-using-aggregate-resource-bundle-locator">Example 4.5, &#8220;Using <code>AggregateResourceBundleLocator</code>&#8221;</a> shows how to use <code>AggregateResourceBundleLocator</code>.</p>
</div>
...
<div class="paragraph">
<p>Let&#8217;s have a look at an example. The class <code>Person</code> in <a href="#example-person">Example 5.1, &#8220;Example class <code>Person</code>&#8221;</a> has a <code>@NotNull</code>
...
<div class="paragraph">
<p>The class <code>Driver</code> in <a href="#example-driver">Example 5.2, &#8220;Driver&#8221;</a> extends <code>Person</code> and adds the properties <code>age</code> and
...
that groups can inherit from each other via class inheritance. See <a href="#section-group-inheritance">Section 5.2, &#8220;Group inheritance&#8221;</a>.</p>
</div>
</td>
</tr>
</table>
...
<div class="paragraph">
<p>Finally the class <code>Car</code> (<a href="#example-car">Example 5.3, &#8220;Car&#8221;</a>) has some constraints which are part of the default group as
...
<div class="paragraph">
<p><a href="#example-drive-away">Example 5.4, &#8220;Using validation groups&#8221;</a> shows how passing different group combinations to the <code>Validator#validate()</code>
...
<div class="paragraph">
<p>The first <code>validate()</code> call in <a href="#example-drive-away">Example 5.4, &#8220;Using validation groups&#8221;</a> is done using no explicit group. There are no
...
<div class="paragraph">
<p>In <a href="#example-drive-away">Example 5.4, &#8220;Using validation groups&#8221;</a>, we need to call <code>validate()</code> for each validation group, or specify all of
them one by one.</p>
</div>
<div class="paragraph">
...
<div class="paragraph">
<p>In <a href="#example-supercar">Example 5.5, &#8220;SuperCar&#8221;</a>, we define a <code>SuperCar</code> and a group <code>RaceCarChecks</code> that extends the <code>Default</code> group.
...
<div class="paragraph">
<p>In the example from <a href="#example-drive-away">Example 5.4, &#8220;Using validation groups&#8221;</a> it could for instance be required that first all default
...
<a href="#example-defining-group-sequence">Example 5.7, &#8220;Defining a group sequence&#8221;</a>). If at least one constraint fails in a sequenced group, none of the
...
<div class="paragraph">
<p>You then can use the new sequence as shown in in <a href="#example-group-sequence">Example 5.8, &#8220;Using a group sequence&#8221;</a>.</p>
</div>
...
<div class="paragraph">
<p><a href="#example-rental-car">Example 5.9, &#8220;Class <code>RentalCar</code> with redefined default group&#8221;</a> introduces a new class <code>RentalCar</code> with a redefined default group.</p>
</div>
...
<code>RentalCar</code> by just requesting the <code>Default</code> group as seen in <a href="#example-testCarIsRented">Example 5.10, &#8220;Validating an object with redefined default group&#8221;</a>.</p>
</div>
...
<a href="#section-group-conversion">Section 5.5, &#8220;Group conversion&#8221;</a>).</p>
</div>
</div>
<div class="sect3">
...
<a href="#example-implementing-using-default-group-sequence-provider">Example 5.11, &#8220;Implementing and using a default group sequence provider&#8221;</a>.</p>
</div>
...
<div class="paragraph">
<p>Let&#8217;s have a look at <a href="#example-group-conversion-dedault-to-driver-checks">Example 5.12, &#8220;<code>@ConvertGroup</code> usage&#8221;</a>. Here <code>@GroupSequence({
CarChecks.class, Car.class })</code> is used to combine the car related constraints under the <code>Default</code> group
(see <a href="#section-default-group-class">Section 5.4, &#8220;Redefining the default group sequence&#8221;</a>). There is also a <code>@ConvertGroup(from = Default.class, to =
...
<div class="paragraph">
<p>As a result the validation in <a href="#example-group-conversion-test">Example 5.13, &#8220;Test case for <code>@ConvertGroup</code>&#8221;</a> succeeds, even though the constraint
...
the <code>licensePlate</code> field of the <code>Car</code> class from <a href="#validator-gettingstarted">Chapter 1, <em>Getting started</em></a> to ensure that
...
belongs (see <a href="#chapter-groups">Chapter 5, <em>Grouping constraints</em></a>). This must default to an empty array of type Class&lt;?&gt;.</p>
</li>
<li>
...
constraints (see <a href="#section-constraint-composition">Section 6.4, &#8220;Constraint composition&#8221;</a>) based on <code>@CheckCase</code>.</p>
<div class="paragraph">
<p>When creating a class-level constraint (see <a href="#validator-usingvalidator-classlevel">Section 2.1.4, &#8220;Class-level constraints&#8221;</a>), the element
...
<a href="#section-cross-parameter-constraints">Section 6.3, &#8220;Cross-parameter constraints&#8221;</a>) which are used to validate all the parameters of a method
...
<div class="paragraph">
<p><a href="#example-constraint-validator">Example 6.3, &#8220;Implementing a constraint validator for the constraint <code>@CheckCase</code>&#8221;</a>
...
<div class="paragraph">
<p><a href="#example-constraint-validator-context">Example 6.4, &#8220;Using <code>ConstraintValidatorContext</code> to define custom error messages&#8221;</a>
...
See <a href="#section-hibernateconstraintvalidatorcontext">Section 12.13.1, &#8220;<code>HibernateConstraintValidatorContext</code>&#8221;</a> for more information.</p>
</div>
<div class="paragraph">
<p>Refer to <a href="#section-custom-property-paths">Section 6.2.1, &#8220;Custom property paths&#8221;</a> to learn how to use the <code>ConstraintValidatorContext</code> API to
control the property path of constraint violations for class-level constraints.</p>
</div>
</div>
<div class="sect4">
<h5 id="constraint-validator-hibernateconstraintvalidator"><a class="anchor" href="#constraint-validator-hibernateconstraintvalidator"></a>6.1.2.2. The <code>HibernateConstraintValidator</code> extension</h5>
<div class="paragraph">
...
<div class="sect4">
<h5 id="constraint-validator-payload"><a class="anchor" href="#constraint-validator-payload"></a>6.1.2.3. Passing a payload to the constraint validator</h5>
<div class="paragraph">
...
following contents (see also <a href="#section-message-interpolation">Section 4.1, &#8220;Default message interpolation&#8221;</a>):</p>
</div>
<div class="exampleblock">
...
<div class="paragraph">
<p>You can now use the constraint in the <code>Car</code> class from the <a href="#validator-gettingstarted">Chapter 1, <em>Getting started</em></a> chapter to
...
<div class="paragraph">
<p>Finally, <a href="#example-using-checkcase">Example 6.11, &#8220;Validating objects with the <code>@CheckCase</code> constraint&#8221;</a> demonstrates how validating a <code>Car</code> instance with an invalid
...
<a href="#example-implementing-classlevel-constraint">Example 6.12, &#8220;Implementing a class-level constraint&#8221;</a> shows constraint annotation and validator of the
<code>@ValidPassengerCount</code> constraint you already saw in use in <a href="#example-class-level">Example 2.9, &#8220;Class-level constraint&#8221;</a>.</p>
</div>
...
<div class="paragraph">
<p><a href="#example-custom-error">Example 6.13, &#8220;Adding a new <code>ConstraintViolation</code> with custom property path&#8221;</a>
...
<a href="#example-cross-parameter-validator">Example 6.15, &#8220;Generic and cross-parameter constraint&#8221;</a>. Note that besides the element types <code>METHOD</code> and <code>CONSTRUCTOR</code>
...
to specify the constraint&#8217;s target as shown in <a href="#example-dual-cross-parameter-constraint">Example 6.16, &#8220;Generic and cross-parameter constraint&#8221;</a>.</p>
</div>
...
<code>RETURN_VALUE</code> as shown in <a href="#example-dual-cross-parameter-constraint-usage">Example 6.17, &#8220;Specifying the target for a generic and cross-parameter constraint&#8221;</a>.</p>
</div>
...
<div class="paragraph">
<p>Looking at the <code>licensePlate</code> field of the <code>Car</code> class in <a href="#example-car-with-checkcase">Example 6.10, &#8220;Applying the <code>@CheckCase</code> constraint&#8221;</a>, you see three
...
basic constraints. <a href="#example-composed-constraint">Example 6.18, &#8220;Creating a composing constraint <code>@ValidLicensePlate</code>&#8221;</a> shows a composed constraint annotation which
...
<div class="sect1">
<h2 id="chapter-valueextraction"><a class="anchor" href="#chapter-valueextraction"></a>7. Value extraction</h2>
<div class="sectionbody">
<div class="paragraph">
...
<div class="sect2">
<h3 id="section-valueextraction-builtinvalueextractors"><a class="anchor" href="#section-valueextraction-builtinvalueextractors"></a>7.1. Built-in value extractors</h3>
<div class="paragraph">
...
<li>
<p><a href="https://openjfx.io/openjfx-docs/">JavaFX</a>'s <code>ObservableValue</code> (see <a href="#section-valueextraction-javafx">Section 7.4, &#8220;JavaFX value extractors&#8221;</a>
for more details).</p>
</li>
</ul>
</div>
...
<a href="https://jakarta.ee/specifications/bean-validation/3.0/jakarta-bean-validation-spec-3.0.html#valueextractordefinition-builtinvalueextractors">Jakarta Bean Validation specification</a>.</p>
</div>
</div>
<div class="sect2">
<h3 id="_implementing_a_valueextractor"><a class="anchor" href="#_implementing_a_valueextractor"></a>7.2. Implementing a <code>ValueExtractor</code></h3>
<div class="paragraph">
...
See <a href="#section-valueextraction-registeringvalueextractor">Section 7.5, &#8220;Registering a <code>ValueExtractor</code>&#8221;</a> for more details.</p>
</div>
</td>
</tr>
</table>
...
<div class="sect2">
<h3 id="_non_generic_containers"><a class="anchor" href="#_non_generic_containers"></a>7.3. Non generic containers</h3>
<div class="paragraph">
...
<div class="sect2">
<h3 id="section-valueextraction-javafx"><a class="anchor" href="#section-valueextraction-javafx"></a>7.4. JavaFX value extractors</h3>
<div class="paragraph">
...
<div class="sect2">
<h3 id="section-valueextraction-registeringvalueextractor"><a class="anchor" href="#section-valueextraction-registeringvalueextractor"></a>7.5. Registering a <code>ValueExtractor</code></h3>
<div class="paragraph">
...
<dd>
<p>See <a href="#section-configuration-validation-xml">Section 8.1, &#8220;Configuring the validator factory in <em>validation.xml</em>&#8221;</a> for more information about
...
<dd>
<p>See <a href="#section-bootstrapping-valueextractors">Section 9.2.6, &#8220;Registering <code>ValueExtractor</code>s&#8221;</a>
...
<div class="sect2">
<h3 id="_resolution_algorithms"><a class="anchor" href="#_resolution_algorithms"></a>7.6. Resolution algorithms</h3>
<div class="paragraph">
...
<ul>
<li>
<p>for <a href="https://jakarta.ee/specifications/bean-validation/3.0/jakarta-bean-validation-spec-3.0.html#constraintdeclarationvalidationprocess-validationroutine-valueextractorresolution-algorithm-constraints">container element constraints</a>,</p>
</li>
<li>
<p>for <a href="https://jakarta.ee/specifications/bean-validation/3.0/jakarta-bean-validation-spec-3.0.html#constraintdeclarationvalidationprocess-validationroutine-valueextractorresolution-algorithm-cascaded">cascaded validation</a>,</p>
</li>
<li>
<p>and for <a href="https://jakarta.ee/specifications/bean-validation/3.0/jakarta-bean-validation-spec-3.0.html#constraintdeclarationvalidationprocess-validationroutine-valueextractorresolution-implicitunwrapping">implicit unwrapping</a>.</p>
</li>
</ul>
</div>
<div class="paragraph">
...
<div class="sect1">
<h2 id="chapter-xml-configuration"><a class="anchor" href="#chapter-xml-configuration"></a>8. Configuring via XML</h2>
<div class="sectionbody">
<div class="paragraph">
...
<div class="sect2">
<h3 id="section-configuration-validation-xml"><a class="anchor" href="#section-configuration-validation-xml"></a>8.1. Configuring the validator factory in <em>validation.xml</em></h3>
<div class="paragraph">
...
gets created. <a href="#image-validation-configuration">Figure 1, &#8220;Validation configuration schema&#8221;</a> shows a model view of the XML schema to which
<em>validation.xml</em> has to adhere.</p>
</div>
<div id="image-validation-configuration" class="imageblock">
<div class="content">
<img src="images/validation-configuration-2.0.png" alt="validation-configuration-2.0.xsd">
</div>
<div class="title">Figure 1. Validation configuration schema</div>
</div>
<div class="paragraph">
<p><a href="#example-validation-xml">Example 8.1, &#8220;<code>validation.xml</code>&#8221;</a>
...
See the sub-sections of <a href="#section-configuring-validator-factory">Section 9.2, &#8220;Configuring a <code>ValidatorFactory</code>&#8221;</a> for more information about these
interfaces.</p>
</div>
<div class="paragraph">
<p><code>value-extractor</code> allows to declare additional value extractors either to extract values from custom
container types or to override the built-in value extractors. See <a href="#chapter-valueextraction">Chapter 7, <em>Value extraction</em></a> for
...
global switch to turn method validation on and off (see also <a href="#chapter-method-constraints">Chapter 3, <em>Declaring and validating method constraints</em></a>).</p>
</div>
<div class="paragraph">
...
<div class="sect2">
<h3 id="section-mapping-xml-constraints"><a class="anchor" href="#section-mapping-xml-constraints"></a>8.2. Mapping constraints via <code>constraint-mappings</code></h3>
<div class="paragraph">
<p>Expressing constraints in XML is possible via files adhering to the schema seen in
<a href="#image-mapping-configuration">Figure 2, &#8220;Validation mapping schema&#8221;</a>. Note that these mapping files are only processed if listed via
constraint-mapping in <em>validation.xml</em>.</p>
</div>
<div id="image-mapping-configuration" class="imageblock">
<div class="content">
<img src="images/validation-mapping-2.0.png" alt="validation-mapping-2.0.xsd">
</div>
<div class="title">Figure 2. Validation mapping schema</div>
</div>
<div class="paragraph">
<p><a href="#example-constraints-car">Example 8.2, &#8220;Bean constraints configured via XML&#8221;</a> shows how the classes Car and RentalCar from <a href="#example-car">Example 5.3, &#8220;Car&#8221;</a> resp.
<a href="#example-rental-car">Example 5.9, &#8220;Class <code>RentalCar</code> with redefined default group&#8221;</a> could be mapped in XML.</p>
</div>
...
<div class="paragraph">
<p><a href="#example-rental-station-xml">Example 8.3, &#8220;Method constraints configured via XML&#8221;</a> shows how the constraints from
<a href="#example-declaring-parameter-constraints">Example 3.1, &#8220;Declaring method and constructor parameter constraints&#8221;</a>, <a href="#example-declaring-return-value-constraints">Example 3.4, &#8220;Declaring method and constructor return value constraints&#8221;</a>
and <a href="#example-specifying-constraint-target">Example 3.3, &#8220;Specifying a constraint&#8217;s target&#8221;</a> can be expressed in XML.</p>
</div>
...
<a href="#section-default-group-class">Section 5.4, &#8220;Redefining the default group sequence&#8221;</a>) via the <code>group-sequence</code> node. Not shown in the example is the use
of <code>convert-group</code> to
specify group conversions (see <a href="#section-group-conversion">Section 5.5, &#8220;Group conversion&#8221;</a>). This node is available on <code>field</code>,
...
<div class="sectionbody">
<div class="paragraph">
<p>In <a href="#section-obtaining-validator">Section 2.2.1, &#8220;Obtaining a <code>Validator</code> instance&#8221;</a>, you already saw one way of creating a <code>Validator</code> instance - via
...
<div class="sect2">
<h3 id="section-retrieving-validator-factory-validator"><a class="anchor" href="#section-retrieving-validator-factory-validator"></a>9.1. Retrieving <code>ValidatorFactory</code> and <code>Validator</code></h3>
<div class="paragraph">
...
<div class="paragraph">
<p><a href="#example-build-default-validator-factory">Example 9.1, &#8220;Bootstrapping default <code>ValidatorFactory</code> and <code>Validator</code>&#8221;</a> shows how to obtain a validator from the default
validator factory:</p>
</div>
...
provider&#8217;s <code>ValidationProvider</code> class as shown in <a href="#example-using-specific-provider">Example 9.2, &#8220;Bootstrapping <code>ValidatorFactory</code> and <code>Validator</code> using a specific provider&#8221;</a>.</p>
</div>
...
<a href="#example-configuring-default-provider">Example 9.3, &#8220;Retrieving the default <code>ValidatorFactory</code> for configuration&#8221;</a>.</p>
</div>
...
<a href="https://docs.oracle.com/javase/8/docs/technotes/guides/jar/jar.html#Service_Provider">Java
...
<a href="#example-using-custom-validation-provider-resolver">Example 9.4, &#8220;Using a custom <code>ValidationProviderResolver</code>&#8221;</a>.</p>
</div>
...
<div class="sect2">
<h3 id="section-configuring-validator-factory"><a class="anchor" href="#section-configuring-validator-factory"></a>9.2. Configuring a <code>ValidatorFactory</code></h3>
<div class="paragraph">
<p>By default, validator factories retrieved from <code>Validation</code> and any validators they create are
configured as per the XML descriptor <em>META-INF/validation.xml</em> (see <a href="#chapter-xml-configuration">Chapter 8, <em>Configuring via XML</em></a>),
if present.</p>
</div>
<div class="paragraph">
...
<div class="paragraph">
<p>In case the default message interpolation algorithm described in <a href="#chapter-message-interpolation">Chapter 4, <em>Interpolating constraint error messages</em></a>
...
<a href="#example-using-custom-message-interpolator">Example 9.5, &#8220;Using a custom <code>MessageInterpolator</code>&#8221;</a>.</p>
</div>
...
<code>TraversableResolver</code> interface. <a href="#example-using-custom-traversable-resolver">Example 9.6, &#8220;Using a custom <code>TraversableResolver</code>&#8221;</a> shows how to use a
...
constructor to instantiate <code>ConstraintValidator</code> instances (see <a href="#section-constraint-validator">Section 6.1.2, &#8220;The constraint validator&#8221;</a>).
...
(see <a href="#example-using-custom-constraint-validator-factory">Example 9.9, &#8220;Using a custom <code>ConstraintValidatorFactory</code>&#8221;</a>.</p>
</div>
...
the provider during bootstrapping as shown in <a href="#example-using-custom-parameter-name-provider">Example 9.10, &#8220;Using a custom <code>ParameterNameProvider</code>&#8221;</a>,
...
(see <a href="#section-configuration-validation-xml">Section 8.1, &#8220;Configuring the validator factory in <em>validation.xml</em>&#8221;</a>). This is demonstrated in
<a href="#example-using-custom-parameter-name-provider">Example 9.10, &#8220;Using a custom <code>ParameterNameProvider</code>&#8221;</a>.</p>
</div>
...
for obtaining parameter names at runtime. Refer to <a href="#section-paranamer-parameternameprovider">Section 12.14, &#8220;Paranamer based <code>ParameterNameProvider</code>&#8221;</a>
...
<div class="sect3">
<h4 id="section-clock-provider"><a class="anchor" href="#section-clock-provider"></a>9.2.5. <code>ClockProvider</code> and temporal validation tolerance</h4>
<div class="paragraph">
...
(see <a href="#chapter-xml-configuration">Chapter 8, <em>Configuring via XML</em></a>).</p>
</div>
<div class="admonitionblock note">
<table>
<tr>
...
the <code>HibernateConstraintValidator</code> contract (see <a href="#constraint-validator-hibernateconstraintvalidator">Section 6.1.2.2, &#8220;The <code>HibernateConstraintValidator</code> extension&#8221;</a>).
...
<div class="sect3">
<h4 id="section-bootstrapping-valueextractors"><a class="anchor" href="#section-bootstrapping-valueextractors"></a>9.2.6. Registering <code>ValueExtractor</code>s</h4>
<div class="paragraph">
<p>As mentioned in <a href="#chapter-valueextraction">Chapter 7, <em>Value extraction</em></a>, additional value extractors can be registered during bootstrapping
(see <a href="#section-valueextraction-registeringvalueextractor">Section 7.5, &#8220;Registering a <code>ValueExtractor</code>&#8221;</a> for the other ways to register a value extractor).</p>
</div>
<div class="paragraph">
<p><a href="#example-registering-value-extractor">Example 9.13, &#8220;Registering additional value extractors&#8221;</a> shows how we would register the value extractors we previously created
...
<div class="sect3">
<h4 id="_adding_mapping_streams"><a class="anchor" href="#_adding_mapping_streams"></a>9.2.7. Adding mapping streams</h4>
<div class="paragraph">
...
<code>Configuration#addMapping()</code> (see <a href="#example-adding-mapping-streams">Example 9.14, &#8220;Adding constraint mapping streams&#8221;</a>). Note that the passed input
...
<div class="sect3">
<h4 id="section-provider-specific-settings"><a class="anchor" href="#section-provider-specific-settings"></a>9.2.8. Provider-specific settings</h4>
<div class="paragraph">
...
<a href="#example-hibernate-validator-specific-options">Example 9.15, &#8220;Setting Hibernate Validator specific options&#8221;</a>.</p>
</div>
...
<div class="paragraph">
<p>Refer to <a href="#section-fail-fast">Section 12.2, &#8220;Fail fast mode&#8221;</a> and <a href="#section-programmatic-api">Section 12.4, &#8220;Programmatic constraint definition and declaration&#8221;</a> to learn more about the fail fast
mode and the constraint declaration API.</p>
</div>
</div>
<div class="sect3">
<h4 id="section-script-evaluator-factory"><a class="anchor" href="#section-script-evaluator-factory"></a>9.2.9. Configuring the <code>ScriptEvaluatorFactory</code></h4>
<div class="paragraph">
...
<div class="sect4">
<h5 id="_xml_configuration"><a class="anchor" href="#_xml_configuration"></a>9.2.9.1. XML configuration</h5>
<div class="paragraph">
...
<div class="sect4">
<h5 id="_programmatic_configuration"><a class="anchor" href="#_programmatic_configuration"></a>9.2.9.2. Programmatic configuration</h5>
<div class="paragraph">
...
This gives more flexibility in the configuration of the <code>ScriptEvaluatorFactory</code>. <a href="#example-script-evaluator-factory-programmatically">Example 9.18, &#8220;Defining the <code>ScriptEvaluatorFactory</code> programmatically&#8221;</a>
...
<div class="sect4">
<h5 id="_custom_scriptevaluatorfactory_implementation_examples"><a class="anchor" href="#_custom_scriptevaluatorfactory_implementation_examples"></a>9.2.9.3. Custom <code>ScriptEvaluatorFactory</code> implementation examples</h5>
<div class="paragraph">
...
<div class="sect3">
<h4 id="_logging_of_values_under_validation"><a class="anchor" href="#_logging_of_values_under_validation"></a>9.2.10. Logging of values under validation</h4>
<div class="paragraph">
<p>In some cases it might be useful to inspect logs produced by Hibernate Validator.
When the log level is set to <code>TRACE</code> validator will produce, among others,
...
can be configured to print these values as well. As usual, there are a few ways to do it:</p>
</div>
<div class="exampleblock">
<div class="title">Example 9.25: Programmatic configuration</div>
<div class="content">
<div class="listingblock">
<div class="content">
<pre class="prettyprint highlight"><code data-lang="JAVA">Validator validator = Validation.byProvider( HibernateValidator.class )
...
<div class="exampleblock">
<div class="title">Example 9.26: Programmatic configuration via property</div>
<div class="content">
<div class="listingblock">
<div class="content">
<pre class="prettyprint highlight"><code data-lang="JAVA">Validator validator = Validation.byProvider( HibernateValidator.class )
...
<div class="exampleblock">
<div class="title">Example 9.27: XML configuration via property</div>
<div class="content">
<div class="listingblock">
<div class="content">
<pre class="prettyprint highlight"><code data-lang="XML">&lt;?xml version="1.0" encoding="UTF-8"?&gt;
...
<td class="content">
<div class="paragraph">
<p>Hibernate Validator versions, prior to 8.0, logged both value and constraint descriptor
if logging level was set to <code>TRACE</code>.</p>
</div>
</td>
</tr>
</table>
...
<div class="sect2">
<h3 id="section-configuring-validator"><a class="anchor" href="#section-configuring-validator"></a>9.3. Configuring a Validator</h3>
<div class="paragraph">
<p>When working with a configured validator factory it can occasionally be required to apply a
different configuration to a single <code>Validator</code> instance. <a href="#example-using-context">Example 9.28, &#8220;Configuring a <code>Validator</code> instance via <code>usingContext()</code>&#8221;</a> shows how this can
be achieved by calling <code>ValidatorFactory#usingContext()</code>.</p>
</div>
<div id="example-using-context" class="exampleblock">
<div class="title">Example 9.28: Configuring a <code>Validator</code> instance via <code>usingContext()</code></div>
<div class="content">
<div class="listingblock">
<div class="content">
<pre class="prettyprint highlight"><code data-lang="JAVA">ValidatorFactory validatorFactory = Validation.buildDefaultValidatorFactory();
...
<div class="sect1">
<h2 id="validator-metadata-api"><a class="anchor" href="#validator-metadata-api"></a>10. Using constraint metadata</h2>
<div class="sectionbody">
<div class="paragraph">
...
<a href="#metadata-example-car">Example 10.1, &#8220;Example classes&#8221;</a>.</p>
</div>
...
returns an instance of the <a href="https://jakarta.ee/specifications/bean-validation/3.0/apidocs//?jakarta/validation/metadata/BeanDescriptor.html"><code>BeanDescriptor</code></a> interface. Using this
...
<div class="paragraph">
<p><a href="#metadata-example-using-beandescriptor">Example 10.2, &#8220;Using <code>BeanDescriptor</code>&#8221;</a> demonstrates how to retrieve a <code>BeanDescriptor</code> for the
...
(see <a href="#validator-metadata-api-elementdescriptor">Section 10.4, &#8220;<code>ElementDescriptor</code>&#8221;</a>) and returns a set of descriptors representing the
...
constraint inheritance as described in <a href="#section-constraint-inheritance">Section 2.1.5, &#8220;Constraint inheritance&#8221;</a>. An example is the
...
<div class="paragraph">
<p>The interface
<a href="https://jakarta.ee/specifications/bean-validation/3.0/apidocs//?jakarta/validation/metadata/PropertyDescriptor.html"><code>PropertyDescriptor</code></a> represents one given property of a
class. It is transparent whether constraints are declared on a field or a property getter, provided
the JavaBeans naming conventions are respected. <a href="#metadata-example-using-propertydescriptor">Example 10.3, &#8220;Using <code>PropertyDescriptor</code>&#8221;</a> shows
...
<div class="sect2">
<h3 id="_methoddescriptor_and_constructordescriptor"><a class="anchor" href="#_methoddescriptor_and_constructordescriptor"></a>10.3. <code>MethodDescriptor</code> and <code>ConstructorDescriptor</code></h3>
<div class="paragraph">
<p>Constrained methods and constructors are represented by the interfaces
<a href="https://jakarta.ee/specifications/bean-validation/3.0/apidocs//?jakarta/validation/metadata/MethodDescriptor.html"><code>MethodDescriptor</code></a>
<a href="https://jakarta.ee/specifications/bean-validation/3.0/apidocs//?jakarta/validation/metadata/ConstructorDescriptor.html"><code>ConstructorDescriptor</code></a>, respectively.
<a href="#metadata-example-using-methodandconstructordescriptor">Example 10.4, &#8220;Using <code>MethodDescriptor</code> and <code>ConstructorDescriptor</code>&#8221;</a> demonstrates how to work with these
descriptors.</p>
</div>
...
the currently used parameter name provider (see <a href="#section-parameter-name-provider">Section 9.2.4, &#8220;<code>ParameterNameProvider</code>&#8221;</a>) via <code>getName()</code>
...
<div class="paragraph">
<p>The <a href="https://jakarta.ee/specifications/bean-validation/3.0/apidocs//?jakarta/validation/metadata/ElementDescriptor.html"><code>ElementDescriptor</code></a>
...
<div class="paragraph">
<p><a href="#metadata-example-using-elementdescriptor">Example 10.5, &#8220;Using <code>ElementDescriptor methods</code>&#8221;</a> shows how these methods are used.</p>
</div>
...
constraint metadata in a fine grained way. <a href="#example-constraint-finder">Example 10.6, &#8220;Usage of <code>ConstraintFinder</code>&#8221;</a> shows how to retrieve a
...
<div class="sect2">
<h3 id="_containerdescriptor_and_containerelementtypedescriptor"><a class="anchor" href="#_containerdescriptor_and_containerelementtypedescriptor"></a>10.5. <code>ContainerDescriptor</code> and <code>ContainerElementTypeDescriptor</code></h3>
<div class="paragraph">
<p>The <a href="https://jakarta.ee/specifications/bean-validation/3.0/apidocs//?jakarta/validation/metadata/ContainerDescriptor.html"><code>ContainerDescriptor</code></a>
...
<div class="paragraph">
<p><a href="#metadata-example-using-containerelementtypedescriptor">Example 10.7, &#8220;Using <code>ContainerElementTypeDescriptor</code>&#8221;</a> shows how to use <code>getConstrainedContainerElementTypes()</code>
...
<a href="https://jakarta.ee/specifications/bean-validation/3.0/apidocs//?jakarta/validation//metadata/GroupConversionDescriptor.html"><code>GroupConversionDescriptor</code></a>
for each configured conversion, allowing to retrieve
source and target groups of the conversion. <a href="#metadata-example-using-groupconversiondescriptor">Example 10.8, &#8220;Using <code>GroupConversionDescriptor</code>&#8221;</a>
shows an example.</p>
</div>
...
<a href="https://jakarta.ee/specifications/bean-validation/3.0/apidocs//?jakarta/validation/metadata/ConstraintDescriptor.html"><code>ConstraintDescriptor</code></a>
...
<div class="paragraph">
<p><a href="#metadata-example-using-constraintdescriptor">Example 10.9, &#8220;Using <code>ConstraintDescriptor</code>&#8221;</a>
...
<div class="sect1">
<h2 id="validator-integration"><a class="anchor" href="#validator-integration"></a>11. Integrating with other frameworks</h2>
<div class="sectionbody">
<div class="paragraph">
...
<div class="sect2">
<h3 id="validator-checkconstraints-orm"><a class="anchor" href="#validator-checkconstraints-orm"></a>11.1. ORM integration</h3>
<div class="paragraph">
...
<div class="sect3">
<h4 id="validator-checkconstraints-db"><a class="anchor" href="#validator-checkconstraints-db"></a>11.1.1. Database schema-level validation</h4>
<div class="paragraph">
...
<code>false</code>. See also <a href="#validator-defineconstraints-spec">Section 2.3.1, &#8220;Jakarta Bean Validation constraints&#8221;</a> and <a href="#validator-defineconstraints-hv-constraints">Section 2.3.2, &#8220;Additional constraints&#8221;</a>.</p>
</div>
<div class="paragraph">
...
<div class="sect3">
<h4 id="validator-checkconstraints-orm-hibernateevent"><a class="anchor" href="#validator-checkconstraints-orm-hibernateevent"></a>11.1.2. Hibernate ORM event-based validation</h4>
<div class="paragraph">
<p>Hibernate Validator has a built-in Hibernate event listener -
<a href="https://github.com/hibernate/hibernate-orm/blob/main/hibernate-core/src/main/java/org/hibernate/cfg/beanvalidation/BeanValidationEventListener.java"><code>org.hibernate.cfg.beanvalidation.BeanValidationEventListener</code></a> -
...
to validate. <a href="#example-beanvalidationeventlistener-config">Example 11.1, &#8220;Manual configuration of <code>BeanValidationEvenListener</code>&#8221;</a> shows the default values for these
...
described in <a href="#validator-checkconstraints-orm-hibernateevent">Section 11.1.2, &#8220;Hibernate ORM event-based validation&#8221;</a> can in this case be configured in
...
runtime environment, validation is triggered for every field in the application. <a href="#example-jsf2">Example 11.2, &#8220;Usage of Jakarta Bean Validation within JSF2&#8221;</a>
...
<div class="paragraph">
<p>When your application runs on a Jakarta EE container, this integration is enabled by default. When
...
class path as described in <a href="#section-getting-started-cdi">Section 1.1.2, &#8220;CDI&#8221;</a>.</p>
</div>
<div class="sect3">
<h4 id="_dependency_injection"><a class="anchor" href="#_dependency_injection"></a>11.3.1. Dependency injection</h4>
<div class="paragraph">
...
<code>@jakarta.inject.Inject</code> as shown in <a href="#example-dependency-injection">Example 11.3, &#8220;Retrieving validator factory and validator via <code>@Inject</code>&#8221;</a>.</p>
</div>
...
as discussed in <a href="#chapter-xml-configuration">Chapter 8, <em>Configuring via XML</em></a>.</p>
</div>
<div class="paragraph">
...
<code>@HibernateValidator</code> qualifier which is demonstrated in <a href="#example-dependency-injection-using-hv">Example 11.4, &#8220;Using the <code>@HibernateValidator</code> qualifier annotation&#8221;</a>.</p>
</div>
...
<div class="paragraph">
<p><a href="#example-constraint-validator-injected-bean">Example 11.5, &#8220;Constraint validator with injected bean&#8221;</a>
...
<div class="sect3">
<h4 id="_method_validation"><a class="anchor" href="#_method_validation"></a>11.3.2. Method validation</h4>
<div class="paragraph">
...
within a Jakarta EE runtime environment or explicitly by adding the <em>hibernate-validator-cdi</em>
artifact - see <a href="#section-getting-started-cdi">Section 1.1.2, &#8220;CDI&#8221;</a></p>
</div>
</td>
</tr>
</table>
...
<div class="paragraph">
<p>You can see an example in <a href="#example-cdi-method-validation">Example 11.6, &#8220;CDI managed beans with method-level constraints&#8221;</a>.</p>
</div>
...
<div class="sect4">
<h5 id="_validated_executable_types"><a class="anchor" href="#_validated_executable_types"></a>11.3.2.1. Validated executable types</h5>
<div class="paragraph">
...
<a href="#example-cdi-method-validation">Example 11.6, &#8220;CDI managed beans with method-level constraints&#8221;</a> does not get validated when the method is invoked.</p>
</div>
<div class="paragraph">
...
see <a href="#section-configuration-validation-xml">Section 8.1, &#8220;Configuring the validator factory in <em>validation.xml</em>&#8221;</a> for an example</p>
</li>
<li>
...
<div class="paragraph">
<p><a href="#example-using-validateonexecution">Example 11.7, &#8220;Using <code>@ValidateOnExecution</code>&#8221;</a> shows how to use the <code>@ValidateOnExecution</code> annotation:</p>
</div>
...
<a href="#example-using-executabletype-implicit">Example 11.8, &#8220;Using <code>ExecutableType.IMPLICIT</code>&#8221;</a>, which makes sure that all required metadata is discovered
...
<div class="sect2">
<h3 id="_jakarta_ee"><a class="anchor" href="#_jakarta_ee"></a>11.4. Jakarta EE</h3>
<div class="paragraph">
<p>When your application runs on a Jakarta EE application server such as <a href="http://wildfly.org/">WildFly</a>,
you also can obtain <code>Validator</code> and <code>ValidatorFactory</code> instances via <code>@Resource</code> injection in
managed objects such as EJBs etc., as shown in <a href="#example-validator-resource-injection">Example 11.9, &#8220;Retrieving <code>Validator</code> and <code>ValidatorFactory</code> via <code>@Resource</code> injection&#8221;</a>.</p>
</div>
...
See <a href="#section-valueextraction-javafx">Section 7.4, &#8220;JavaFX value extractors&#8221;</a> for examples and further discussion.</p>
</div>
</div>
</div>
</div>
<div class="sect1">
<h2 id="validator-specifics"><a class="anchor" href="#validator-specifics"></a>12. Hibernate Validator Specifics</h2>
<div class="sectionbody">
<div class="paragraph">
...
<div class="sect2">
<h3 id="_public_api"><a class="anchor" href="#_public_api"></a>12.1. Public API</h3>
<div class="paragraph">
...
<dd>
<p>Some useful custom constraints provided by Hibernate Validator in addition to the built-in constraints defined by the Jakarta Bean Validation specification; the constraints are described in detail in <a href="#validator-defineconstraints-hv-constraints">Section 2.3.2, &#8220;Additional constraints&#8221;</a>.</p>
</dd>
...
<dd>
<p>The group sequence provider feature which allows you to define dynamic default group sequences in function of the validated object state; the specifics can be found in <a href="#section-default-group-class">Section 5.4, &#8220;Redefining the default group sequence&#8221;</a>.</p>
</dd>
...
<div class="sect2">
<h3 id="section-fail-fast"><a class="anchor" href="#section-fail-fast"></a>12.2. Fail fast mode</h3>
<div class="paragraph">
...
<div class="paragraph">
<p><a href="#example-using-fail-fast">Example 12.1, &#8220;Using the fail fast validation mode&#8221;</a> shows how to bootstrap and use a fail fast enabled validator.</p>
</div>
...
<a href="#section-defining-group-sequences">Section 5.3, &#8220;Defining group sequences&#8221;</a>.</p>
</div>
</td>
</tr>
</table>
...
<div class="paragraph">
<p>Refer to <a href="#section-provider-specific-settings">Section 9.2.8, &#8220;Provider-specific settings&#8221;</a> to learn about the different ways of enabling the
fail fast mode when bootstrapping a validator.</p>
</div>
</div>
<div class="sect2">
<h3 id="section-method-validation-prerequisite-relaxation"><a class="anchor" href="#section-method-validation-prerequisite-relaxation"></a>12.3. Relaxation of requirements for method validation in class hierarchies</h3>
<div class="paragraph">
...
<a href="https://jakarta.ee/specifications/bean-validation/3.0/jakarta-bean-validation-spec-3.0.html#constraintdeclarationvalidationprocess-methodlevelconstraints-inheritance">section 5.6.5</a>
of the Jakarta Bean Validation specification. See also <a href="#section-method-constraints-inheritance-hierarchies">Section 3.1.4, &#8220;Method constraints in inheritance hierarchies&#8221;</a>
in this guide.</p>
</div>
<div class="paragraph">
...
<a href="#example-relaxing-method-validation-xml">Example 12.2, &#8220;Configuring method validation behaviour in class hierarchies via properties&#8221;</a>.</p>
</div>
...
<div class="sect2">
<h3 id="section-programmatic-api"><a class="anchor" href="#section-programmatic-api"></a>12.4. Programmatic constraint definition and declaration</h3>
<div class="paragraph">
...
manner as shown in <a href="#example-constraint-mapping">Example 12.4, &#8220;Programmatic constraint declaration&#8221;</a>.</p>
</div>
...
you can use <code>GenericConstraintDef</code> as seen in <a href="#example-generic-constraint-mapping">Example 12.5, &#8220;Programmatic declaration of a custom constraint&#8221;</a>.</p>
</div>
...
<div class="paragraph">
<p><a href="#example-nested-container-element-constraints">Example 12.6, &#8220;Programmatic declaration of a nested container element constraint&#8221;</a> show an example where constraints are declared on
...
<a href="#example-cascading-constraints">Example 12.7, &#8220;Marking a property for cascaded validation&#8221;</a>.</p>
</div>
...
constraints. As shown in <a href="#example-method-constraint-mapping">Example 12.8, &#8220;Programmatic declaration of method and constructor constraints&#8221;</a> constructors are identified by their
...
<div class="sect2">
<h3 id="section-programmatic-api-contributor"><a class="anchor" href="#section-programmatic-api-contributor"></a>12.5. Applying programmatic constraint declarations to the default validator factory</h3>
<div class="paragraph">
...
(see <a href="#chapter-xml-configuration">Chapter 8, <em>Configuring via XML</em></a>),
...
<div class="sect2">
<h3 id="section-advanced-constraint-composition"><a class="anchor" href="#section-advanced-constraint-composition"></a>12.6. Advanced constraint composition features</h3>
<div class="sect3">
<h4 id="_validation_target_specification_for_purely_composed_constraints"><a class="anchor" href="#_validation_target_specification_for_purely_composed_constraints"></a>12.6.1. Validation target specification for purely composed constraints</h4>
<div class="paragraph">
...
declaration of the composed constraint type as shown in <a href="#example-purely-composed-constraint-validation-target">Example 12.11, &#8220;Specifying the validation target of a purely composed constraint&#8221;</a>.
...
<div class="sect3">
<h4 id="section-boolean-constraint-composition"><a class="anchor" href="#section-boolean-constraint-composition"></a>12.6.2. Boolean composition of constraints</h4>
<div class="paragraph">
<p>Jakarta Bean Validation specifies that the constraints of a composed constraint (see
<a href="#section-constraint-composition">Section 6.4, &#8220;Constraint composition&#8221;</a>) are all combined via a logical <em>AND</em>. This means all of the
...
<div class="paragraph">
<p><a href="#example-boolean-constraint-composition">Example 12.12, &#8220;OR composition of constraints&#8221;</a> shows how to build a composed constraint <code>@PatternOrSize</code>
...
<div class="sect2">
<h3 id="section-extensions-path-api"><a class="anchor" href="#section-extensions-path-api"></a>12.7. Extensions of the Path API</h3>
<div class="paragraph">
...
<div class="sect2">
<h3 id="section-dynamic-payload"><a class="anchor" href="#section-dynamic-payload"></a>12.8. Dynamic payload as part of <code>ConstraintViolation</code></h3>
<div class="paragraph">
...
This is shown in example <a href="#example-constraint-validator-setting-dynamic-payload">Example 12.14, &#8220;<code>ConstraintValidator</code> implementation setting a dynamic payload&#8221;</a> where the
...
<div class="sect2">
<h3 id="el-features"><a class="anchor" href="#el-features"></a>12.9. Enabling Expression Language features</h3>
<div class="paragraph">
...
<a href="#validator-gettingstarted-uel">Section 1.1.1, &#8220;Unified EL&#8221;</a>) to be available. This is needed to allow the interpolation
...
<div class="paragraph">
<p>Refer to <a href="#section-custom-message-interpolation">Section 4.2, &#8220;Custom message interpolation&#8221;</a> to see how to plug in custom message interpolator
implementations.</p>
</div>
<div class="admonitionblock warning">
<table>
...
<div class="sect2">
<h3 id="section-locale-resolver"><a class="anchor" href="#section-locale-resolver"></a>12.12. Customizing the locale resolution</h3>
<div class="admonitionblock warning">
<table>
<tr>
<td class="icon">
...
<div class="sect2">
<h3 id="_custom_contexts"><a class="anchor" href="#_custom_contexts"></a>12.13. Custom contexts</h3>
<div class="paragraph">
...
<div class="title">Example 155. Custom <code>@Future</code> validator injecting an expression variable</div>
<div class="content">
<div class="listingblock">
<div class="content">
...
<div class="title">Example 156. Custom <code>@Future</code> validator injecting a message parameter</div>
<div class="content">
<div class="listingblock">
<div class="content">
<pre class="prettyprint highlight"><code data-lang="JAVA">package org.hibernate.validator.referenceguide.chapter12.context;
...
<code>HibernateMessageInterpolatorContext</code> (see <a href="#example-custom-message-interpolator-context">Example 12.18, &#8220;<code>HibernateMessageInterpolatorContext</code>&#8221;</a>). This
...
<div class="sect2">
<h3 id="section-paranamer-parameternameprovider"><a class="anchor" href="#section-paranamer-parameternameprovider"></a>12.14. Paranamer based <code>ParameterNameProvider</code></h3>
<div class="paragraph">
...
validator as shown in <a href="#example-using-custom-parameter-name-provider">Example 9.10, &#8220;Using a custom <code>ParameterNameProvider</code>&#8221;</a> or specify
...
<div class="sect2">
<h3 id="section-constraint-definition-contribution"><a class="anchor" href="#section-constraint-definition-contribution"></a>12.15. Providing constraint definitions</h3>
<div class="paragraph">
<p>Jakarta Bean Validation allows to (re-)define constraint definitions via XML in its constraint mapping
files. See <a href="#section-mapping-xml-constraints">Section 8.2, &#8220;Mapping constraints via <code>constraint-mappings</code>&#8221;</a> for more information and <a href="#example-constraints-car">Example 8.2, &#8220;Bean constraints configured via XML&#8221;</a>
...
<div class="sect3">
<h4 id="_constraint_definitions_via_serviceloader"><a class="anchor" href="#_constraint_definitions_via_serviceloader"></a>12.15.1. Constraint definitions via <code>ServiceLoader</code></h4>
<div class="paragraph">
<p>Hibernate Validator allows to utilize Java&#8217;s
<a href="https://docs.oracle.com/en/java/javase/11/docs/api/?java/util/ServiceLoader.html">ServiceLoader</a>
...
<div class="title">Example 12.19: <em>META-INF/services/jakarta.validation.ConstraintValidator</em></div>
<div class="content">
<div class="listingblock">
<div class="content">
...
<div class="sect3">
<h4 id="section-programmatic-constraint-definition"><a class="anchor" href="#section-programmatic-constraint-definition"></a>12.15.2. Adding constraint definitions programmatically</h4>
<div class="paragraph">
...
<a href="#example-using-constraint-definition-api">Example 12.20, &#8220;Adding constraint definitions through the programmatic API&#8221;</a>.</p>
</div>
...
as detailed in <a href="#section-programmatic-api-contributor">Section 12.5, &#8220;Applying programmatic constraint declarations to the default validator factory&#8221;</a>. This can be useful when
...
However, there is also a purely regular expression based version available, which can be configured using
the programmatic constraint declaration API:</p>
</div>
<div class="listingblock">
...
<div class="sect2">
<h3 id="section-constraint-customizing-class-loading"><a class="anchor" href="#section-constraint-customizing-class-loading"></a>12.16. Customizing class-loading</h3>
<div class="paragraph">
...
<div class="sect2">
<h3 id="section-getter-property-selection-strategy"><a class="anchor" href="#section-getter-property-selection-strategy"></a>12.17. Customizing the getter property selection strategy</h3>
<div class="paragraph">
...
as illustrated in <a href="#example-using-fluent-api-pattern">Example 12.23, &#8220;A class that uses non-standard getters&#8221;</a>.</p>
</div>
...
programmatically (see <a href="#custom-getter-strategy-programmatically">Example 12.26, &#8220;Configuring a custom <code>GetterPropertySelectionStrategy</code> programmatically&#8221;</a>) or by using the
<code>hibernate.validator.getter_property_selection_strategy</code> property in the XML configuration
(see <a href="#custom-getter-strategy-xml">Example 12.27, &#8220;Configuring a custom <code>GetterPropertySelectionStrategy</code> using an XML property&#8221;</a>).</p>
</div>
...
<div class="sect2">
<h3 id="section-property-node-name-provider"><a class="anchor" href="#section-property-node-name-provider"></a>12.18. Customizing the property name resolution for constraint violations</h3>
<div class="paragraph">
...
should be used as a default way of resolving the name (see how it is used in <a href="#example-jackson-property-node-name-provider">Example 12.31, &#8220;JacksonPropertyNodeNameProvider implementation&#8221;</a>).</p>
</li>
<li>
...
<div class="sect1">
<h2 id="validator-annotation-processor"><a class="anchor" href="#validator-annotation-processor"></a>13. Annotation Processor</h2>
<div class="sectionbody">
<div class="paragraph">
...
<td class="content">
<div class="paragraph">
<p>You can find the Hibernate Validator Annotation Processor
in the Maven repositories such as Maven Central under the GAV
<code>org.hibernate.validator:hibernate-validator-annotation-processor:8.0.5.Final</code>.</p>
</div>
</td>
</tr>
</table>
...
<div class="sect2">
<h3 id="validator-annotationprocessor-prerequisites"><a class="anchor" href="#validator-annotationprocessor-prerequisites"></a>13.1. Prerequisites</h3>
<div class="paragraph">
...
<div class="sect2">
<h3 id="validator-annotationprocessor-features"><a class="anchor" href="#validator-annotationprocessor-features"></a>13.2. Features</h3>
<div class="paragraph">
<p>As of Hibernate Validator 8.0.5.Final the Hibernate Validator Annotation Processor checks that:</p>
</div>
<div class="ulist">
<ul>
<li>
...
<div class="sect2">
<h3 id="validator-annotationprocessor-options"><a class="anchor" href="#validator-annotationprocessor-options"></a>13.3. Options</h3>
<div class="paragraph">
<p>The behavior of the Hibernate Validator Annotation Processor can be controlled using the following
<a href="https://docs.oracle.com/javase/8/docs/technotes/tools/windows/javac.html#BHCHACIB">processor options</a>:</p>
</div>
<div class="dlist">
<dl>
...
<div class="sect2">
<h3 id="validator-annotationprocessor-usage"><a class="anchor" href="#validator-annotationprocessor-usage"></a>13.4. Using the Annotation Processor</h3>
<div class="paragraph">
...
<div class="sect3">
<h4 id="validator-annotationprocessor-commandline"><a class="anchor" href="#validator-annotationprocessor-commandline"></a>13.4.1. Command line builds</h4>
<div class="sect4">
...
<pre class="prettyprint highlight"><code data-lang="groovy">dependencies {
    annotationProcessor group: 'org.hibernate.validator', name: 'hibernate-validator-annotation-processor', version: '8.0.5.Final'
...
<pre class="prettyprint highlight"><code data-lang="XML">&lt;javac srcdir="src/main"
       ...
       &lt;compilerarg value="/path/to/hibernate-validator-annotation-processor-8.0.5.Final.jar"/&gt;
&lt;/javac&gt;</code></pre>
</div>
</div>
</div>
...
<a href="https://docs.oracle.com/javase/8/docs/technotes/guides/javac/index.html">javac</a>, specify the JAR
<em>hibernate-validator-annotation-processor-8.0.5.Final.jar</em> using the "processorpath" option as shown in
...
<pre>javac src/main/java/org/hibernate/validator/ap/demo/Car.java \
   ...
   -processorpath /path/to/hibernate-validator-annotation-processor-8.0.5.Final.jar</pre>
</div>
</div>
</div>
</div>
...
<li>
<p>Go to "Java Compiler" and make sure, that "Compiler compliance level" is set to "11".
...
hibernate-validator-annotation-processor-8.0.5.Final.jar</p>
</li>
<li>
...
/path/to/hibernate-validator-annotation-processor-8.0.5.Final.jar</p>
</li>
<li>
...
<li>
<p>Go to "Libraries", tab "Processor", and add the JAR hibernate-validator-annotation-processor-8.0.5.Final.jar</p>
</li>
<li>
...
<a href="https://docs.hibernate.org/stable/validator/reference/en-US/html_single/#chapter-xml-configuration">using XML</a> are
...
<div class="sect1">
<h2 id="validator-further-reading"><a class="anchor" href="#validator-further-reading"></a>14. Further reading</h2>
<div class="sectionbody">
<div class="paragraph">
...
<a href="https://github.com/eclipse-ee4j/beanvalidation-tck/tree/master/tests">tests</a> might be
of interest. <a href="https://jakarta.ee/specifications/bean-validation/3.0/jakarta-bean-validation-spec-3.0.html">The Jakarta Bean Validation</a> specification itself
...
<div id="footer">
<div id="footer-text">
Last updated 2026-07-26 15:00:44 UTC
</div>
</div>
...
<!-- /Dynamic TOC -->
<script>(function(){function c(){var b=a.contentDocument||(a.contentWindow&&a.contentWindow.document);if(b){var d=b.createElement('script');d.innerHTML="window.__CF$cv$params={r:'a33c4ada4e67b231',t:'MTc4ODE4MjAwNA=='};var a=document.createElement('script');a.src='/cdn-cgi/challenge-platform/scripts/jsd/main.js';document.getElementsByTagName('head')[0].appendChild(a);";b.getElementsByTagName('head')[0].appendChild(d)}}if(document.body){var a=document.createElement('iframe');a.height=1;a.width=1;a.style.position='absolute';a.style.top=0;a.style.left=0;a.style.border='none';a.style.visibility='hidden';document.body.appendChild(a);if('loading'!==document.readyState)c();else if(window.addEventListener)document.addEventListener('DOMContentLoaded',c);else{var e=document.onreadystatechange||function(){};document.onreadystatechange=function(b){e(b);'loading'!==document.readyState&&(document.onreadystatechange=e,c())}}}})();</script></body>
</html>