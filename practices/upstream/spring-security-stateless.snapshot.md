# spring-security-stateless — upstream snapshot (2026-08-01 refresh, append-only)

**Source URL(s):** https://docs.spring.io/spring-security/reference/servlet/authentication/session-management.html (re-fetched 2026-08-01; every pre-existing section below the divider is preserved verbatim)
**HTTP status:** 200
**Fetched at:** 2026-08-01T02:24:32Z
**Extractor invocation:** `practices/scripts/snapshot-extract.sh https://docs.spring.io/spring-security/reference/servlet/authentication/session-management.html`
**Fetch receipt:** `practices/upstream/_FETCH-RECEIPTS.yaml` id `r154`
**Body SHA-256 (below the `---` divider, header excluded):** 605edd5fc0db5623cd0a29b4152f40232a450ba652fa6be1952c7b6a13217caf
...
Source: https://docs.spring.io/spring-security/reference/servlet/authentication/session-management.html
HTTP status: 200 · extracted bytes: 33311 · sha256: 2b5ef29272c897c394fb7ce90bba183a07cf7523030358a7fb895e2597fbee68
