# spring-cache-2026-05 — upstream snapshot (2026-08-01 refresh, append-only)

**Source URL(s):** https://docs.spring.io/spring-framework/reference/integration/cache/specific-config.html (re-fetched 2026-08-01; every pre-existing section below the divider is preserved verbatim)
**HTTP status:** 200
**Fetched at:** 2026-08-01T02:24:28Z
**Extractor invocation:** `practices/scripts/snapshot-extract.sh https://docs.spring.io/spring-framework/reference/integration/cache/specific-config.html`
**Fetch receipt:** `practices/upstream/_FETCH-RECEIPTS.yaml` id `r139`
**Body SHA-256 (below the `---` divider, header excluded):** 70fe3a0210d61c0fbae32946741e17d9535f0a447b546ff028045ecec5854e8b
...
Source: https://docs.spring.io/spring-framework/reference/integration/cache/specific-config.html
HTTP status: 200 · extracted bytes: 13853 · sha256: 93e01cf86c3b1ba6a520cefba40ac736f6f21ffac12477a427a73bd947252a5f
