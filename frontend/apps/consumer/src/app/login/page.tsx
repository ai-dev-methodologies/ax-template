...
/**
 * Standalone login for the consumer feed. Composes the catalog Field / Button /
 ...
 * param (or the feed home). Persona shell class (.ax-consumer) is applied so the
 * rounded radius + high-saturation accent reach every catalog component here.
 */
