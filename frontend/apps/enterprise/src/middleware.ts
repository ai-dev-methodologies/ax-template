 ...
 * `from` param so the user lands back where they started after signing in. The
 * ADMIN check itself is done client-side against the live /api/auth/me role,
 * since middleware cannot safely decode/verify the JWT here.
 */
