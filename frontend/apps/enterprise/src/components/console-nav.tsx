...
const NAV: NavItem[] = [
  ...
  { href: '/feature-flags', label: '기능 플래그', icon: ToggleRight },
  { href: '/sessions', label: '세션', icon: MonitorSmartphone },
  { href: '/exports', label: '리포트 추출', icon: Download },
];
...
/**
 * Persona-themed navigation rail. The active item uses a flat token fill (no
 * glow) per the enterprise-operator motion budget; only color transitions on
 * hover/active (state-feedback-only).
 */
