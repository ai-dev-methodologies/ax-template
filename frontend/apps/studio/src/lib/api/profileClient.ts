 ...
 * `UserProfile` shape (canonicalized in P1-73). This per-app client remains so the studio
 * shell can greet the creator by email + show their avatar initials. The token
