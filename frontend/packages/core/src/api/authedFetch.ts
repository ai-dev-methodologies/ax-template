/**
 * Shared authed-fetch base for per-persona apps.
 *
 ...
 *
 * Per-persona apps build their domain clients (audit-log, approvals, etc.) on
 * top of this — they MUST NOT re-implement an authed fetch wrapper of their own.
 */
...
/** Authed binary download. Returns a Blob + filename parsed from Content-Disposition. */
