...
/**
 * Login feature container (frontend decomposition spec §7 — extracted from the route
 * app/(auth)/login/page.tsx, which is now a thin re-export of this slice's barrel).
 */
