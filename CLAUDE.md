...
```
fork ax-template
    ↓ (25 L4 domains + 11 active recipes + 233 Java rules + 102 React rules + 15 ESLint rules + 104 hard guards + AGENTS.md sentinel)
...
│   ├── evals/                 # 4 hard gates + 104 hard guards
