...
*/
/**
 * @ax-codified-from 21st.dev/bucharitesh/split-text-effect
 * @ax-layer L2/blocks/text
...
const Component = React.forwardRef<HTMLDivElement, SplitTextEffectProps>(
  ({ text, fill = 0.5, accent = "var(--ax-c-1)", className, ...props }, ref) => {
