...
const shareButtons = [
  { icon: Twitter, label: 'Twitter', color: 'hover:text-[var(--ax-c-1)] hover:bg-[var(--ax-c-1)]/10' },
  { icon: Instagram, label: 'Instagram', color: 'hover:text-[var(--ax-c-2)] hover:bg-[var(--ax-c-2)]/10' },
  { icon: Linkedin, label: 'LinkedIn', color: 'hover:text-[var(--ax-c-3)] hover:bg-[var(--ax-c-3)]/10' },
]
