/*
---
template_id: L1/components/form
layer: L1
...
a11y_criteria:
  ...
  - "FormMessage uses aria-live='polite' for error announcements"
dependencies: ["react-hook-form", "@radix-ui/react-label"]
drift_snapshot_ref: "practices-react/upstream/shadcn-registry-2026-05.snapshot.md#form"
---
*/
...
>(({ className, children, ...props }, ref) => {
  ...
  return (
    <p
      ...
      aria-live="polite"
      className={cn(
        'text-[length:--text-sm] font-[number:--weight-medium] text-[--color-error]',
        className
      )}
      {...props}
    >
