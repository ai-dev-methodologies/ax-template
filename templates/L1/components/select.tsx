/*
---
template_id: L1/components/select
layer: L1
...
evidence:
  - source_type: upstream_id
    ...
    section: select
    quote: "Displays a list of options for the user to pick from—triggered by a button."
  - source_type: upstream_id
...
a11y_criteria:
  - "WCAG 2.2 SC 4.1.2 Name/Role/Value — forward aria-label / aria-labelledby"
  - "WCAG 2.2 SC 2.4.3 Focus Order — keyboard navigable via Radix Select"
dependencies: ["@radix-ui/react-select"]
drift_snapshot_ref: "practices-react/upstream/shadcn-registry-2026-05.snapshot.md#select"
---
*/
...
>(({ className, children, ...props }, ref) => (
  <SelectPrimitive.Trigger
    ...
    className={cn(
      ...
      'border border-[--color-border] bg-transparent px-[--space-3] py-[--space-2]',
      'text-[length:--text-base] shadow-[--shadow-sm]',
...
>(({ className, ...props }, ref) => (
  <SelectPrimitive.ScrollUpButton
    ...
    {...props}
  >
    <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" aria-hidden="true"><path d="m18 15-6-6-6 6"/></svg>
  </SelectPrimitive.ScrollUpButton>
))
...
>(({ className, children, position = 'popper', ...props }, ref) => (
  <SelectPrimitive.Portal>
    <SelectPrimitive.Content
      ref={ref}
      className={cn(
        'relative z-[--z-dropdown] max-h-96 min-w-[8rem] overflow-hidden',
        'rounded-[--radius-md] border border-[--color-border]',
        'bg-[--color-surface] text-[--color-text] shadow-[--shadow-md]',
...
>(({ className, ...props }, ref) => (
  <SelectPrimitive.Label
    ref={ref}
    className={cn('px-2 py-1.5 text-[length:--text-sm] font-[number:--weight-semibold]', className)}
    {...props}
  />
))
...
>(({ className, children, ...props }, ref) => (
  <SelectPrimitive.Item
    ...
    className={cn(
      ...
      'focus:bg-[--color-accent] focus:text-[--color-text-inverse]',
