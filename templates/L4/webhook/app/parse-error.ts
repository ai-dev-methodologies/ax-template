/*
---
template_id: L4/webhook/app/parse-error
layer: L4
domain: webhook
...
evidence:
  - source_type: internal
    rationale: "L4 webhook vertical — shared RFC 9457 ProblemDetail unwrap with text/html fallback + PII deny-list (R44/R46 closure)."
