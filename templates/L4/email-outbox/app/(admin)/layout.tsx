/*
---
template_id: L4/email-outbox/app/(admin)/layout
layer: L4
domain: email-outbox
...
evidence:
  - source_type: internal
    rationale: "L4 email-outbox vertical — admin route group layout."
...
interface EmailOutboxLayoutProps {
  children: React.ReactNode
}

const NAV_ITEMS = [
  { href: '/admin/email-outbox', label: 'Outbox', icon: 'mail' as const },
]

export default function EmailOutboxLayout({ children }: EmailOutboxLayoutProps) {
  return (
    <AppShell
      sidebar={<Sidebar navItems={NAV_ITEMS} />}
      header={<AppHeader title="Email outbox" />}
    >
      {children}
    </AppShell>
  )
