/*
---
template_id: L4/scheduled-task/app/use-caller-id
layer: L4
...
evidence:
  - source_type: internal
    rationale: "L4 scheduled-task vertical — shared caller-id + role hook. The entire scheduled-task admin surface is ROLE_ADMIN-gated server-side (/api/admin/scheduled-tasks); the role hook mirrors the gate so non-admin viewers see read-only / blocked UI instead of buttons that would 403."
 ...
 * `NEXT_PUBLIC_DEV_AS_ADMIN=1` opt-in.
 */
