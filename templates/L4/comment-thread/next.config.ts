/*
---
template_id: L4/comment-thread/next.config
layer: L4
...
evidence:
  - source_type: internal
    rationale: "L4 comment-thread vertical — minimal Next.js config for fork-receiver build test."
...
/**
 * next.config.ts — minimal config for L4/comment-thread fork-receiver build test.
 *
 * Fork instructions:
