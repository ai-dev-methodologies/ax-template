/*
---
template_id: L4/session-management/next.config
layer: L4
...
evidence:
  - source_type: internal
    rationale: "L4 session-management vertical — minimal Next.js config for fork-receiver build test."
...
/**
 * next.config.ts — minimal config for L4/session-management fork-receiver build test.
 *
 * Fork instructions:
