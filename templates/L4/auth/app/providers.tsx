/*
---
template_id: L4/auth/app/providers
layer: L4
domain: auth
...
evidence:
  - source_type: internal
    rationale: "L4 auth vertical — client provider tree: QueryClientProvider for server-state + MSW conditional for dev mock server."
...
/**
 * Providers — client-side provider tree for the L4 auth vertical.
 *
 * Wraps the app with:
 *   - QueryClientProvider (TanStack Query v5 for server state)
 *   - MSW (Mock Service Worker) in development only — see src/mocks/browser.ts
 *
 * Fork instructions:
 *   1. Add your global state providers here (Zustand store context, etc.)
