/*
---
template_id: L4/data-subject-rights/app/providers
layer: L4
...
evidence:
  - source_type: internal
    rationale: "L4 data-subject-rights vertical — client provider tree: QueryClientProvider for server-state + MSW conditional for dev mock server."
...
/**
 * Providers — client-side provider tree for the L4 data-subject-rights vertical.
 *
 * Wraps the app with:
