/*
---
template_id: L4/data-subject-rights/app/(dsr)/page
layer: L4
...
evidence:
  - source_type: internal
    rationale: "L4 data-subject-rights vertical — dsr route group root redirects to /privacy console."
...
/**
 * Dsr route group root — redirects to the privacy console.
 *
 * Fork instructions:
 *   Update the redirect target if your console route differs.
 */
export default function DsrRootPage() {
  redirect('/privacy')
}
