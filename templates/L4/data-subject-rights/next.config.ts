/*
---
template_id: L4/data-subject-rights/next.config
layer: L4
...
evidence:
  - source_type: internal
    rationale: "L4 data-subject-rights vertical — minimal Next.js config for fork-receiver build test."
...
/**
 * next.config.ts — minimal config for L4/data-subject-rights fork-receiver build test.
 *
 * Fork instructions:
