...
fork ax-template
       ↓
25 L4 domains + 11 active recipes · 187 Java rules · 99 React rules · 8 ESLint rules · 75 hard guards · L0 fork-receiver-kit · L2 rate-limit-banner · AGENTS.md sentinel
       ↓
...
bash practices/evals/run-all-guards.sh       # 75 hard guards (all PASS expected)
