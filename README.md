...
fork ax-template
       ↓
25 L4 domains + 11 active recipes · 233 Java rules · 102 React rules · 15 ESLint rules · 103 hard guards · L0 fork-receiver-kit · L2 rate-limit-banner · AGENTS.md sentinel
       ↓
...
bash practices/evals/run-all-guards.sh       # 103 hard guards (all PASS expected; the pre-push recency guard runs from .githooks/pre-push, not from here)
