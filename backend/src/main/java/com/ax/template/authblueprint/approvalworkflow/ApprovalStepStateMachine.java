...
public class ApprovalStepStateMachine {
     ...
     */
    public boolean canTransition(ApprovalStepStatus from, ApprovalStepStatus to) {
        return ALLOWED.getOrDefault(from, EnumSet.noneOf(ApprovalStepStatus.class)).contains(to);
    }
