...
/** Shared helpers for signed-dual-register net-metering integration tests (mirrors RegisterTestSupport). */
public final class NetMeterTestSupport {

    private NetMeterTestSupport() {}
