...
/** Shared helpers for negative-copresence-gate integration tests (mirrors NettingTestSupport). */
public final class CopresenceTestSupport {

    private CopresenceTestSupport() {}
