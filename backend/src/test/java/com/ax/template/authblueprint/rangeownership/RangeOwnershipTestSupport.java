...
/** Shared helpers for range-ownership integration tests (mirrors PlausibilityTestSupport). */
public final class RangeOwnershipTestSupport {

    private RangeOwnershipTestSupport() {}
