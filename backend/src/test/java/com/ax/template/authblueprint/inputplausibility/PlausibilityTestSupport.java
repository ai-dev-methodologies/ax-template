...
/** Shared helpers for input-plausibility integration tests (mirrors DunningTestSupport). */
public final class PlausibilityTestSupport {

    private PlausibilityTestSupport() {}
