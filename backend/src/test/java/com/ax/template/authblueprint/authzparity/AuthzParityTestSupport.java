...
/** Shared helpers for authorization-parity integration tests (mirrors LinkageTestSupport). */
public final class AuthzParityTestSupport {

    private AuthzParityTestSupport() {}
