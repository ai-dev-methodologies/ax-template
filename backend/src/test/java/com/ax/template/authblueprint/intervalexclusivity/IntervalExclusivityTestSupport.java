...
/** Shared helpers for interval-exclusivity integration tests (mirrors ThresholdTestSupport). */
public final class IntervalExclusivityTestSupport {

    private IntervalExclusivityTestSupport() {}
