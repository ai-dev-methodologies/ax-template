...
/** Shared helpers for dimensional-uom-conversion integration tests (mirrors DunningTestSupport). */
public final class UomConversionTestSupport {

    private UomConversionTestSupport() {}
