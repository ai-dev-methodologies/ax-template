...
/** Shared helpers for timed-offer-exclusive-assignment integration tests (mirrors DunningTestSupport). */
public final class TimedOfferTestSupport {

    private TimedOfferTestSupport() {}
