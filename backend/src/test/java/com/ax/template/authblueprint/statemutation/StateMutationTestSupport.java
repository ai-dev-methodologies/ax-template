...
/** Shared helpers for state-conditional-mutability integration tests (mirrors DunningTestSupport). */
public final class StateMutationTestSupport {

    private StateMutationTestSupport() {}
