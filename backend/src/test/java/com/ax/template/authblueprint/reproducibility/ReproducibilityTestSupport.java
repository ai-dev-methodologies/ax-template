...
/** Shared helpers for reproducible-procedure integration tests (mirrors DunningTestSupport). */
public final class ReproducibilityTestSupport {

    private ReproducibilityTestSupport() {}
