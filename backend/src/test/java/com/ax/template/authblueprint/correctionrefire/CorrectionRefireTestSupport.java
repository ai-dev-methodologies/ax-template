...
/** Shared helpers for correction-refire integration tests (mirrors ValuationRunTestSupport). */
public final class CorrectionRefireTestSupport {

    private CorrectionRefireTestSupport() {}
