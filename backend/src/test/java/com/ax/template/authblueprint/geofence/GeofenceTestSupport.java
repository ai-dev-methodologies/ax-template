...
/** Shared helpers for geofence-transition integration tests (mirrors TimedOfferTestSupport). */
public final class GeofenceTestSupport {

    private GeofenceTestSupport() {}
