...
/** Shared helpers for variance-tolerance-band integration tests (mirrors DunningTestSupport). */
public final class VarianceTestSupport {

    private VarianceTestSupport() {}
