...
/** Shared helpers for route-leg-contiguity integration tests (mirrors TimedOfferTestSupport). */
public final class RouteLegTestSupport {

    private RouteLegTestSupport() {}
