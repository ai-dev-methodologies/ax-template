...
/** Shared helpers for monotonic-event-ingest integration tests (mirrors TrueUpTestSupport). */
public final class EventIngestTestSupport {

    private EventIngestTestSupport() {}
