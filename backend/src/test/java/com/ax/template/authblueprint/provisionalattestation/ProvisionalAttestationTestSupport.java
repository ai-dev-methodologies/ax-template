...
/** Shared helpers for provisional-attestation integration tests (mirrors ValuationRunTestSupport). */
public final class ProvisionalAttestationTestSupport {

    private ProvisionalAttestationTestSupport() {}
