...
/** Shared helpers for completion-reset-recurring-interval integration tests (mirrors ObligationTestSupport). */
public final class RecurringIntervalTestSupport {

    private RecurringIntervalTestSupport() {}
