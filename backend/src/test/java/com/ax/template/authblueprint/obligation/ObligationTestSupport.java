...
/** Shared helpers for deadline-obligation integration tests (mirrors DecisionTestSupport). */
public final class ObligationTestSupport {

    private ObligationTestSupport() {}
