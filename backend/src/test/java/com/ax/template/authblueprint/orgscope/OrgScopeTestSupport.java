...
/** Shared helpers for containment-scope-authz integration tests (mirrors DunningTestSupport). */
public final class OrgScopeTestSupport {

    private OrgScopeTestSupport() {}
