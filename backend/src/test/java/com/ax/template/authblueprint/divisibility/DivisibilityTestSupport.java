...
/** Shared helpers for material-divisibility-constraint integration tests (mirrors DunningTestSupport). */
public final class DivisibilityTestSupport {

    private DivisibilityTestSupport() {}

    public static String freshEmail(String prefix) {
        return prefix + "-" + UUID.randomUUID() + "@example.com";
    }

    public static String freshMaterial(String prefix) {
