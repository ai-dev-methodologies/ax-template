...
| `favorites-bookmarks` *(R35a / R46)* | **impl** ✅ | **full-trio** | — (ready; `./gradlew testFavorites` GREEN); R46 promoted via 2-persona dogfood + `FavoriteToggle` embed component. **Closes the R39 stub upgrade sequence — all 7 R39 stubs now full-trio.** |
