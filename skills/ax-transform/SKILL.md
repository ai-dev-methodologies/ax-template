...
- [ ] Step 7: Run the guard suite (104 hard guards — 6 core evidence gates + domain/meta guards) — `bash practices/evals/run-all-guards.sh` exits 0
...
### Step 7: Guard suite
Script: `practices/evals/run-all-guards.sh` — chains all 104 hard guards. The 6
