...
| **practices/ catalog** (195 rules, 22+ categories) | Evidence-anchored Java/Spring rules. AI cannot invent rules at random — every rule has an external URL / quote / RFC / JEP citation. |
...
| `practices/AGENTS.md` | The 195 rules in AI-consumable form, with sha256 sentinel |
...
- [ ] Step 7: Run the guard suite (80 hard guards — 6 core evidence gates + domain/meta guards) — `bash practices/evals/run-all-guards.sh` exits 0
...
### Step 7: Guard suite
Script: `practices/evals/run-all-guards.sh` — chains all 80 hard guards. The 6
