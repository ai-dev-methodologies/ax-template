...
| **practices/ catalog** (144 rules, 22+ categories) | Evidence-anchored Java/Spring rules. AI cannot invent rules at random — every rule has an external URL / quote / RFC / JEP citation. |
...
| `practices/AGENTS.md` | The 144 rules in AI-consumable form, with sha256 sentinel |
